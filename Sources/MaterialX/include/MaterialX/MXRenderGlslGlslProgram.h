...
public:
  ...
  static GlslProgramPtr create() { return GlslProgramPtr(new GlslProgram()); }
  ...
  struct MX_RENDERGLSL_API Input {
    ...
    Input(int inputLocation, int inputType, int inputSize,
        ...
        : location(inputLocation), gltype(inputType), size(inputSize),
...
protected:
  ...
  ImagePtr bindTexture(unsigned int uniformType, int uniformLocation,
