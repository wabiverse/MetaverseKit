...
public:
  ...
  explicit VectorN(const vector<S> &vec) {
    std::copy(vec.begin(), vec.end(), _arr.begin());
  }
  explicit VectorN(const S *begin, const S *end) {
    std::copy(begin, end, _arr.begin());
  }
  ...
  V getNormalized() const { return *this / getMagnitude(); }
...
public:
  ...
  Vector2() = default;
  Vector2(float x, float y) : VectorN(Uninit{}) { _arr = {x, y}; }
...
public:
  ...
  Vector3() = default;
  Vector3(float x, float y, float z) : VectorN(Uninit{}) { _arr = {x, y, z}; }
...
public:
  ...
  Color3() = default;
  Color3(float r, float g, float b) : VectorN(Uninit{}) { _arr = {r, g, b}; }
...
public:
  ...
  explicit MatrixN(const S *begin, const S *end) {
    std::copy(begin, end, &_arr[0][0]);
  }
  ...
  M operator/(const M &rhs) const { return *this * rhs.getInverse(); }
...
public:
  ...
  Matrix33(float m00, float m01, float m02, float m10, float m11, float m12,
      ...
      : MatrixN(Uninit{}) {
    _arr = {RowArray{m00, m01, m02}, RowArray{m10, m11, m12},
  ...
  Matrix33 getInverse() const { return getAdjugate() / getDeterminant(); }
...
public:
  ...
  Matrix44() = default;
  Matrix44(float m00, float m01, float m02, float m03, float m10, float m11,
           float m12, float m13, float m20, float m21, float m22, float m23,
           float m30, float m31, float m32, float m33)
      : MatrixN(Uninit{}) {
    _arr = {RowArray{m00, m01, m02, m03}, RowArray{m10, m11, m12, m13},
            RowArray{m20, m21, m22, m23}, RowArray{m30, m31, m32, m33}};
  }
  ...
  /// Return the inverse of the matrix.
  Matrix44 getInverse() const { return getAdjugate() / getDeterminant(); }
