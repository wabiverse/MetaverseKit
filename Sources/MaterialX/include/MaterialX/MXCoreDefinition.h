...
public:
  ...
  void setNodeString(const string &node) { setAttribute(NODE_ATTRIBUTE, node); }

  /// Return true if the given NodeDef has a node string.
  bool hasNodeString() const { return hasAttribute(NODE_ATTRIBUTE); }

  /// Return the node string of the NodeDef.
  const string &getNodeString() const { return getAttribute(NODE_ATTRIBUTE); }
  ...
  bool hasNodeGroup() const { return hasAttribute(NODE_GROUP_ATTRIBUTE); }
  ...
  InterfaceElementPtr
  getImplementation(const string &target = EMPTY_STRING) const;
  ...
  getDeclaration(const string &target = EMPTY_STRING) const override;
...
public:
  ...
  void setFile(const string &file) { setAttribute(FILE_ATTRIBUTE, file); }

  /// Return true if the given Implementation has a file string.
  bool hasFile() const { return hasAttribute(FILE_ATTRIBUTE); }

  /// Return the file string for the Implementation.
  const string &getFile() const { return getAttribute(FILE_ATTRIBUTE); }
  ...
  bool hasFunction() const { return hasAttribute(FUNCTION_ATTRIBUTE); }

  /// Return the function string for the Implementation.
  const string &getFunction() const { return getAttribute(FUNCTION_ATTRIBUTE); }
  ...
  bool hasNodeGraph() const { return hasAttribute(NODE_GRAPH_ATTRIBUTE); }
...
public:
  ...
  bool hasSemantic() const { return hasAttribute(SEMANTIC_ATTRIBUTE); }

  /// Return the semantic string of the TypeDef.
  const string &getSemantic() const { return getAttribute(SEMANTIC_ATTRIBUTE); }
  ...
  bool hasContext() const { return hasAttribute(CONTEXT_ATTRIBUTE); }

  /// Return the context string of the TypeDef.
  const string &getContext() const { return getAttribute(CONTEXT_ATTRIBUTE); }
  ...
  vector<MemberPtr> getMembers() const { return getChildrenOfType<Member>(); }

  /// Remove the Member, if any, with the given name.
  void removeMember(const string &name) { removeChildOfType<Member>(name); }
...
public:
  ...
  vector<UnitPtr> getUnits() const { return getChildrenOfType<Unit>(); }

  /// Remove the Unit, if any, with the given name.
  void removeUnit(const string &name) { removeChildOfType<Unit>(name); }
...
public:
  ...
  bool hasAttrName() const { return hasAttribute(ATTRNAME_ATTRIBUTE); }

  /// Return the element's attrname string.
  const string &getAttrName() const { return getAttribute(ATTRNAME_ATTRIBUTE); }
  ...
  bool hasElements() const { return hasAttribute(ELEMENTS_ATTRIBUTE); }

  /// Return the element's elements string.
  const string &getElements() const { return getAttribute(ELEMENTS_ATTRIBUTE); }
