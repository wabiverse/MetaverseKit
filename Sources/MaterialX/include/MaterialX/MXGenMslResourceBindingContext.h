...
using MslResourceBindingContextPtr =
...
class MX_GENMSL_API MslResourceBindingContext
    : public HwResourceBindingContext {
public:
  MslResourceBindingContext(size_t uniformBindingLocation,
                            size_t samplerBindingLocation);

  static MslResourceBindingContextPtr
  create(size_t uniformBindingLocation = 0, size_t samplerBindingLocation = 0) {
    return std::make_shared<MslResourceBindingContext>(uniformBindingLocation,
