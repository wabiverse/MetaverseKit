...
public:
  ...
  string getSwizzledVariable(const string &srcName, const TypeDesc *srcType,
                             const string &channels,
                             const TypeDesc *dstType) const override;
  ...
  bool remapEnumeration(
      ...
      std::pair<const TypeDesc *, ValuePtr> &result) const override;
