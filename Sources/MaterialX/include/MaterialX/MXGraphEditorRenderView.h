...
class RenderView {
public:
  RenderView(mx::DocumentPtr doc, const std::string &meshFilename,
  ...
  std::vector<mx::MeshPartitionPtr> getGeometryList() { return _geometryList; }

  mx::FileSearchPath getMaterialSearchPath() { return _materialSearchPath; }

  // Set the view width.
  void setViewWidth(int width) { _viewWidth = width; }

  // Return the view width.
  int getViewWidth() const { return _viewWidth; }

  // Set the view height.
  void setViewHeight(int height) { _viewHeight = height; }

  // Return the view height.
  int getViewHeight() const { return _viewHeight; }

  // Return the pixel ratio.
  float getPixelRatio() const { return _pixelRatio; }
  ...
  mx::GenContext &getGenContext() { return _genContext; }

  std::map<mx::MeshPartitionPtr, mx::GlslMaterialPtr> getMaterialAssignments() {
    return _materialAssignments;
  }

  std::vector<mx::GlslMaterialPtr> getMaterials() { return _materials; }

  mx::CameraPtr getViewCamera() { return _viewCamera; }

  const mx::StringSet &getXincludeFiles() const { return _xincludeFiles; }
  ...
  float getCameraZoom() { return _cameraZoom; }

  void setCameraZoom(float amount) { _cameraZoom = amount; }

  bool getMaterialCompilation() { return _materialCompilation; }

  void setMaterialCompilation(bool mat) { _materialCompilation = mat; }
  ...
  void assignMaterial(mx::MeshPartitionPtr geometry,
