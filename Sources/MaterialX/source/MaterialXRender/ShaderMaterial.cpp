...
void ShaderMaterial::setDocument(DocumentPtr doc) { _doc = doc; }

DocumentPtr ShaderMaterial::getDocument() const { return _doc; }

void ShaderMaterial::setElement(TypedElementPtr val) { _elem = val; }

TypedElementPtr ShaderMaterial::getElement() const { return _elem; }

void ShaderMaterial::setMaterialNode(NodePtr node) { _materialNode = node; }

NodePtr ShaderMaterial::getMaterialNode() const { return _materialNode; }

void ShaderMaterial::setUdim(const std::string &val) { _udim = val; }

const std::string &ShaderMaterial::getUdim() { return _udim; }

ShaderPtr ShaderMaterial::getShader() const { return _hwShader; }

bool ShaderMaterial::hasTransparency() const { return _hasTransparency; }
