...
const std::string options =
    ...
    "    --mesh [FILENAME]              Specify the filename of the OBJ mesh "
    "to be displayed in the viewer\n"
    "    --meshRotation [VECTOR3]       Specify the rotation of the displayed "
    "mesh as three comma-separated floats, representing rotations in degrees "
    "about the X, Y, and Z axes (defaults to 0,0,0)\n"
    "    --meshScale [FLOAT]            Specify the uniform scale of the "
    "displayed mesh\n"
    "    --enableTurntable[BOOLEAN]     Specify whether to enable turntable "
    "rendering of the scene\n"
    "    --turntableSteps [INTEGER]     Specify the number of steps for a "
    "complete turntable rotation. Defaults to 360\n"
    "    --cameraPosition [VECTOR3]     Specify the position of the camera as "
    "three comma-separated floats (defaults to 0,0,5)\n"
    "    --cameraTarget [VECTOR3]       Specify the position of the camera "
    "target as three comma-separated floats (defaults to 0,0,0)\n"
    "    --cameraViewAngle [FLOAT]      Specify the view angle of the camera, "
    "or zero for an orthographic projection (defaults to 45)\n"
    "    --cameraZoom [FLOAT]           Specify the zoom factor for the "
    "camera, implemented as a mesh scale multiplier (defaults to 1)\n"
    "    --envRad [FILENAME]            Specify the filename of the "
    "environment light to display, stored as HDR environment radiance in the "
    "latitude-longitude format\n"
    "    --envMethod [INTEGER]          Specify the environment lighting "
    "method (0 = filtered importance sampling, 1 = prefiltered environment "
    "maps, defaults to 0)\n"
    "    --envSampleCount [INTEGER]     Specify the environment sample count "
    "(defaults to 16)\n"
    "    --lightRotation [FLOAT]        Specify the rotation in degrees of the "
    "lighting environment about the Y axis (defaults to 0)\n"
    "    --shadowMap [BOOLEAN]          Specify whether shadow mapping is "
    ...
    "libraries.\n"
    "    --screenWidth [INTEGER]        Specify the width of the screen image "
    "in pixels (defaults to 1280)\n"
    "    --screenHeight [INTEGER]       Specify the height of the screen image "
    "in pixels (defaults to 960)\n"
    "    --screenColor [VECTOR3]        Specify the background color of the "
    "viewer as three comma-separated floats (defaults to 0.3,0.3,0.32)\n"
    "    --drawEnvironment [BOOLEAN]    Specify whether to render the "
    "environment as the background (defaults to false)\n"
    "    --captureFilename [FILENAME]   Specify the filename to which the "
    "first rendered frame should be written\n"
    "    --bakeWidth [INTEGER]          Specify the target width for texture "
    "baking (defaults to maximum image width of the source document)\n"
    "    --bakeHeight [INTEGER]         Specify the target height for texture "
    "baking (defaults to maximum image height of the source document)\n"
    "    --bakeFilename [STRING]        Specify the output document filename "
    "for texture baking\n"
    "    --refresh [FLOAT]              Specify the refresh period for the "
    "viewer in milliseconds (defaults to 50, set to -1 to disable)\n"
...
int main(int argc, char *const argv[]) {
  ...
  ng::init();
  {
    ng::ref<Viewer> viewer = new Viewer(
        materialFilename, meshFilename, envRadianceFilename, searchPath,
        libraryFolders, screenWidth, screenHeight, screenColor);
