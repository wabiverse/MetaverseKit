...
EMSCRIPTEN_BINDINGS(GenOptions) {
  ...
  ems::enum_<mx::HwDirectionalAlbedoMethod>("HwDirectionalAlbedoMethod")
      .value("DIRECTIONAL_ALBEDO_ANALYTIC",
             mx::HwDirectionalAlbedoMethod::DIRECTIONAL_ALBEDO_ANALYTIC)
      .value("DIRECTIONAL_ALBEDO_TABLE",
             mx::HwDirectionalAlbedoMethod::DIRECTIONAL_ALBEDO_TABLE)
      .value("DIRECTIONAL_ALBEDO_MONTE_CARLO",
             mx::HwDirectionalAlbedoMethod::DIRECTIONAL_ALBEDO_MONTE_CARLO);
  ...
  ems::class_<mx::GenOptions>("GenOptions")
      ...
      .property("hwDirectionalAlbedoMethod",
                &mx::GenOptions::hwDirectionalAlbedoMethod)
