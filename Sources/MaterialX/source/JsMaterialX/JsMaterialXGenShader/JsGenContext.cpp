...
void initContext(mx::GenContext &context, mx::FileSearchPath searchPath,
  ...
  context.getOptions().hwDirectionalAlbedoMethod =
      mx::DIRECTIONAL_ALBEDO_ANALYTIC;
...
/// Tries to load the standard libaries and initialize the given generation
/// context. The loaded libraries are added to the returned document
...
EMSCRIPTEN_BINDINGS(GenContext) {
  ems::class_<mx::GenContext>("GenContext")
      ...
      .function("getOptions",
                PTR_RETURN_OVERLOAD(mx::GenOptions & (mx::GenContext::*)(),
                                    &mx::GenContext::getOptions),
