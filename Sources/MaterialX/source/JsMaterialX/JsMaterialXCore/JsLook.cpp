...
EMSCRIPTEN_BINDINGS(look) {
  ems::class_<mx::Look, ems::base<mx::Element>>("Look")
      .smart_ptr_constructor(
          "Look",
          &std::make_shared<mx::Look, mx::ElementPtr, const std::string &>)
      .smart_ptr<std::shared_ptr<const mx::Look>>("Look") BIND_MEMBER_FUNC(
          "addMaterialAssign", mx::Look, addMaterialAssign, 0, 2, stRef, stRef)
      ...
      .function("removeMaterialAssign", &mx::Look::removeMaterialAssign)
          BIND_MEMBER_FUNC("addPropertyAssign", mx::Look, addPropertyAssign, 0,
                           1, stRef)
      ...
      .function("removePropertyAssign", &mx::Look::removePropertyAssign)
          BIND_MEMBER_FUNC("addPropertySetAssign", mx::Look,
                           addPropertySetAssign, 0, 1, stRef)
      .function("getPropertySetAssign", &mx::Look::getPropertySetAssign)
      .function("getPropertySetAssigns", &mx::Look::getPropertySetAssigns)
      .function("getActivePropertySetAssigns",
                &mx::Look::getActivePropertySetAssigns)
      .function("removePropertySetAssign", &mx::Look::removePropertySetAssign)
          BIND_MEMBER_FUNC("addVariantAssign", mx::Look, addVariantAssign, 0, 1,
                           stRef)
      ...
      .function("removeVariantAssign", &mx::Look::removeVariantAssign)
          BIND_MEMBER_FUNC("addVisibility", mx::Look, addVisibility, 0, 1,
                           stRef)
  ...
  ems::class_<mx::LookGroup, ems::base<mx::Element>>("LookGroup")
      .smart_ptr_constructor(
          "LookGroup",
          &std::make_shared<mx::LookGroup, mx::ElementPtr, const std::string &>)
  ...
  ems::class_<mx::MaterialAssign, ems::base<mx::GeomElement>>("MaterialAssign")
      .smart_ptr_constructor(
          "MaterialAssign",
          &std::make_shared<mx::MaterialAssign, mx::ElementPtr,
                            const std::string &>)
      ...
      .function("getReferencedMaterial",
                &mx::MaterialAssign::getReferencedMaterial)
          BIND_MEMBER_FUNC("addVariantAssign", mx::MaterialAssign,
                           addVariantAssign, 0, 1, stRef)
  ...
  ems::class_<mx::Visibility, ems::base<mx::GeomElement>>("Visibility")
      ...
      .class_property("VIEWER_GEOM_ATTRIBUTE",
                      &mx::Visibility::VIEWER_GEOM_ATTRIBUTE)
      .class_property("VIEWER_COLLECTION_ATTRIBUTE",
                      &mx::Visibility::VIEWER_COLLECTION_ATTRIBUTE)
      .class_property("VISIBILITY_TYPE_ATTRIBUTE",
