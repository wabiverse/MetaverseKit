...
EMSCRIPTEN_BINDINGS(document) {
  ...
  ems::class_<mx::Document, ems::base<mx::GraphElement>>("Document")
      .smart_ptr_constructor(
          "Document",
          &std::make_shared<mx::Document, mx::ElementPtr, const std::string &>)
      .smart_ptr<std::shared_ptr<const mx::Document>>("Document")
      // At the moment only the Document type is used. Once more types are added
      // this binding needs to be adapted accordingly.
      .class_function("createDocument",
                      &mx::Document::createDocument<mx::Document>)
      .function("initialize", &mx::Document::initialize)
      .function("copy", &mx::Document::copy)
      .function("importLibrary", &mx::Document::importLibrary)
      .function("getReferencedSourceUris",
                ems::optional_override([](mx::Document &self) {
                  mx::StringSet set = self.getReferencedSourceUris();
                  return ems::val::array(set.begin(), set.end());
                })) BIND_MEMBER_FUNC("addNodeGraph", mx::Document, addNodeGraph,
                                     0, 1, stRef)
      ...
      .function("getMatchingPorts", &mx::Document::getMatchingPorts)
          BIND_MEMBER_FUNC("addGeomInfo", mx::Document, addGeomInfo, 0, 2,
                           stRef, stRef)
      ...
      .function("removeGeomInfo", &mx::Document::removeGeomInfo)
          BIND_MEMBER_FUNC("getGeomPropValue", mx::Document, getGeomPropValue,
                           1, 2, stRef, stRef)
      ...
      .function("removeLook", &mx::Document::removeLook) BIND_MEMBER_FUNC(
          "addLookGroup", mx::Document, addLookGroup, 0, 1, stRef)
      ...
      .function("removeLookGroup", &mx::Document::removeLookGroup)
          BIND_MEMBER_FUNC("addCollection", mx::Document, addCollection, 0, 1,
                           stRef)
      ...
      .function("removeTypeDef", &mx::Document::removeTypeDef) BIND_MEMBER_FUNC(
          "addNodeDef", mx::Document, addNodeDef, 0, 3, stRef, stRef, stRef)
          BIND_MEMBER_FUNC("addNodeDefFromGraph", mx::Document,
                           addNodeDefFromGraph, 7, 7, const mx::NodeGraphPtr,
      ...
      .function("getMatchingNodeDefs", &mx::Document::getMatchingNodeDefs)
          BIND_MEMBER_FUNC("addAttributeDef", mx::Document, addAttributeDef, 0,
                           1, stRef)
      ...
      .function("removeAttributeDef", &mx::Document::removeAttributeDef)
          BIND_MEMBER_FUNC("addTargetDef", mx::Document, addTargetDef, 0, 1,
                           stRef)
      ...
      .function("removeTargetDef", &mx::Document::removeTargetDef)
          BIND_MEMBER_FUNC("addPropertySet", mx::Document, addPropertySet, 0, 1,
                           stRef)
      ...
      .function("removePropertySet", &mx::Document::removePropertySet)
          BIND_MEMBER_FUNC("addVariantSet", mx::Document, addVariantSet, 0, 1,
                           stRef)
      ...
      .function("removeVariantSet", &mx::Document::removeVariantSet)
          BIND_MEMBER_FUNC("addImplementation", mx::Document, addImplementation,
                           0, 1, stRef)
      ...
      .function("getMatchingImplementations",
                &mx::Document::getMatchingImplementations)
      ...
      .function("setColorManagementSystem",
                &mx::Document::setColorManagementSystem)
      .function("hasColorManagementSystem",
                &mx::Document::hasColorManagementSystem)
      .function("getColorManagementSystem",
                &mx::Document::getColorManagementSystem)
      .function("setColorManagementConfig",
                &mx::Document::setColorManagementConfig)
      .function("hasColorManagementConfig",
                &mx::Document::hasColorManagementConfig)
      .function("getColorManagementConfig",
                &mx::Document::getColorManagementConfig)
      ...
      .class_property("CMS_CONFIG_ATTRIBUTE",
