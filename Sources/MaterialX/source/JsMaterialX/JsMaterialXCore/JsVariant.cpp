...
EMSCRIPTEN_BINDINGS(variant) {
  ems::class_<mx::Variant, ems::base<mx::InterfaceElement>>("Variant")
      .smart_ptr_constructor(
          "Variant",
          &std::make_shared<mx::Variant, mx::ElementPtr, const std::string &>)
  ...
  ems::class_<mx::VariantSet, ems::base<mx::Element>>("VariantSet")
      .smart_ptr_constructor("VariantSet",
                             &std::make_shared<mx::VariantSet, mx::ElementPtr,
                                               const std::string &>)
      .smart_ptr<std::shared_ptr<const mx::VariantSet>>("VariantSet")
          BIND_MEMBER_FUNC("addVariant", mx::VariantSet, addVariant, 0, 1,
                           stRef)
  ...
  ems::class_<mx::VariantAssign, ems::base<mx::Element>>("VariantAssign")
      .smart_ptr_constructor(
          "VariantAssign", &std::make_shared<mx::VariantAssign, mx::ElementPtr,
                                             const std::string &>)
      ...
      .class_property("VARIANT_SET_ATTRIBUTE",
