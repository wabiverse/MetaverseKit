...
#define BIND_ITERABLE_PROTOCOL(NAME)                                           \
  ...
  EM_ASM(Module[#NAME]['prototype'][Symbol.iterator] =                         \
             function() { return this; };);

EMSCRIPTEN_BINDINGS(traversal) {
  ems::class_<mx::Edge>("Edge")
      .smart_ptr_constructor("Edge",
                             &std::make_shared<mx::Edge, mx::ElementPtr,
                                               mx::ElementPtr, mx::ElementPtr>)
      .function("equals",
                ems::optional_override([](mx::Edge &self, const mx::Edge &rhs) {
                  return self == rhs;
                }))
      .function("notEquals",
                ems::optional_override([](mx::Edge &self, const mx::Edge &rhs) {
  ...
  ems::class_<mx::TreeIterator>("TreeIterator")
      .smart_ptr_constructor(
          "TreeIterator", &std::make_shared<mx::TreeIterator, mx::ElementPtr>)
      ...
      .smart_ptr_constructor(
          "GraphIterator", &std::make_shared<mx::GraphIterator, mx::ElementPtr>)
      .function("getDownstreamElement",
                &mx::GraphIterator::getDownstreamElement)
      .function("getConnectingElement",
                &mx::GraphIterator::getConnectingElement)
      ...
      .smart_ptr_constructor(
          "InheritanceIterator",
          &std::make_shared<mx::InheritanceIterator, mx::ConstElementPtr>)
