...
#define BIND_TYPE_INSTANCE(NAME, T)                                            \
  ems::class_<mx::TypedValue<T>, ems::base<mx::Value>>("TypedValue" #NAME)     \
      ...
      .function("setData", ems::select_overload<void(const T &value)>(         \
                               &mx::TypedValue<T>::setData))                   \
      .function("setDataTypedValue",                                           \
                ems::select_overload<void(const mx::TypedValue<T> &value)>(    \
                    &mx::TypedValue<T>::setData))                              \
      ...
      .class_function("createFromString",                                      \
                      &mx::TypedValue<T>::createFromString);
...
EMSCRIPTEN_BINDINGS(value) {
  ems::enum_<mx::Value::FloatFormat>("FloatFormat")
      ...
      .value("FloatFormatScientific",
             mx::Value::FloatFormat::FloatFormatScientific);
  ...
  ems::class_<mx::Value>("Value")
      ...
      .class_function("createValueFromStrings",
                      &mx::Value::createValueFromStrings)
      ...
      .class_function(
          "getFloatPrecision",
          &mx::Value::getFloatPrecision) BIND_TYPE_SPECIFIC_VALUE_FUNCS(Integer,
                                                                        int)
          BIND_TYPE_SPECIFIC_VALUE_FUNCS(
              Boolean, bool) BIND_TYPE_SPECIFIC_VALUE_FUNCS(Float, float)
              BIND_TYPE_SPECIFIC_VALUE_FUNCS(
                  Color3, mx::Color3) BIND_TYPE_SPECIFIC_VALUE_FUNCS(Color4,
                                                                     mx::Color4)
                  BIND_TYPE_SPECIFIC_VALUE_FUNCS(
                      Vector2,
                      mx::Vector2) BIND_TYPE_SPECIFIC_VALUE_FUNCS(Vector3,
                                                                  mx::Vector3)
                      BIND_TYPE_SPECIFIC_VALUE_FUNCS(Vector4, mx::Vector4)
                          BIND_TYPE_SPECIFIC_VALUE_FUNCS(Matrix33, mx::Matrix33)
                              BIND_TYPE_SPECIFIC_VALUE_FUNCS(Matrix44,
                                                             mx::Matrix44)
                                  BIND_TYPE_SPECIFIC_VALUE_FUNCS(String,
                                                                 std::string)
                                      BIND_TYPE_SPECIFIC_VALUE_FUNCS(
