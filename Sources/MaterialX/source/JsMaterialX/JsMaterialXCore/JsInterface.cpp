...
#define BIND_INTERFACE_TYPE_INSTANCE(NAME, T)                                  \
  BIND_MEMBER_FUNC("setInputValue" #NAME, mx::InterfaceElement,                \
                   setInputValue<T>, 2, 3, stRef, const T &, stRef)
...
EMSCRIPTEN_BINDINGS(interface) {
  ems::class_<mx::PortElement, ems::base<mx::ValueElement>>("PortElement")
      ...
      .function("validChannelsCharacters",
                &mx::PortElement::validChannelsCharacters)
      ...
      .class_property("NODE_NAME_ATTRIBUTE",
                      &mx::PortElement::NODE_NAME_ATTRIBUTE)
      .class_property("NODE_GRAPH_ATTRIBUTE",
                      &mx::PortElement::NODE_GRAPH_ATTRIBUTE)
      .class_property("OUTPUT_ATTRIBUTE", &mx::PortElement::OUTPUT_ATTRIBUTE)
      .class_property("CHANNELS_ATTRIBUTE",
                      &mx::PortElement::CHANNELS_ATTRIBUTE);

  ems::class_<mx::Input, ems::base<mx::PortElement>>("Input")
      .smart_ptr_constructor(
          "Input",
          &std::make_shared<mx::Input, mx::ElementPtr, const std::string &>)
      .smart_ptr<std::shared_ptr<const mx::Input>>("Input")
      .function("setDefaultGeomPropString",
                &mx::Input::setDefaultGeomPropString)
      .function("hasDefaultGeomPropString",
                &mx::Input::hasDefaultGeomPropString)
      .function("getDefaultGeomPropString",
                &mx::Input::getDefaultGeomPropString)
      ...
      .class_property("DEFAULT_GEOM_PROP_ATTRIBUTE",
                      &mx::Input::DEFAULT_GEOM_PROP_ATTRIBUTE);

  ems::class_<mx::Output, ems::base<mx::PortElement>>("Output")
      .smart_ptr_constructor(
          "Output",
          &std::make_shared<mx::Output, mx::ElementPtr, const std::string &>)
      ...
      .class_property("DEFAULT_INPUT_ATTRIBUTE",
                      &mx::Output::DEFAULT_INPUT_ATTRIBUTE);

  ems::class_<mx::InterfaceElement, ems::base<mx::TypedElement>>(
      "InterfaceElement")
      .smart_ptr<std::shared_ptr<mx::InterfaceElement>>("InterfaceElement")
      .smart_ptr<std::shared_ptr<const mx::InterfaceElement>>(
          "InterfaceElement")
      ...
      .function("getNodeDefString", &mx::InterfaceElement::getNodeDefString)
          BIND_MEMBER_FUNC("addInput", mx::InterfaceElement, addInput, 0, 2,
                           stRef, stRef)
      ...
      .function("getActiveInputs", &mx::InterfaceElement::getActiveInputs)
          BIND_MEMBER_FUNC("addOutput", mx::InterfaceElement, addOutput, 0, 2,
                           stRef, stRef)
      ...
      .function("getActiveValueElement",
                &mx::InterfaceElement::getActiveValueElement)
      .function("getActiveValueElements",
                &mx::InterfaceElement::getActiveValueElements)
          BIND_INTERFACE_TYPE_INSTANCE(
              Integer, int) BIND_INTERFACE_TYPE_INSTANCE(Boolean, bool)
              BIND_INTERFACE_TYPE_INSTANCE(
                  Float, float) BIND_INTERFACE_TYPE_INSTANCE(Color3, mx::Color3)
                  BIND_INTERFACE_TYPE_INSTANCE(
                      Color4,
                      mx::Color4) BIND_INTERFACE_TYPE_INSTANCE(Vector2,
                                                               mx::Vector2)
                      BIND_INTERFACE_TYPE_INSTANCE(
                          Vector3,
                          mx::Vector3) BIND_INTERFACE_TYPE_INSTANCE(Vector4,
                                                                    mx::Vector4)
                          BIND_INTERFACE_TYPE_INSTANCE(Matrix33, mx::Matrix33)
                              BIND_INTERFACE_TYPE_INSTANCE(Matrix44,
                                                           mx::Matrix44)
                                  BIND_INTERFACE_TYPE_INSTANCE(String,
                                                               std::string)
                                      BIND_INTERFACE_TYPE_INSTANCE(IntegerArray,
                                                                   mx::IntVec)
                                          BIND_INTERFACE_TYPE_INSTANCE(
      ...
      .function("getDefaultVersion", &mx::InterfaceElement::getDefaultVersion)
          BIND_MEMBER_FUNC("getDeclaration", mx::InterfaceElement,
                           getDeclaration, 0, 1, stRef)
      .class_property("NODE_DEF_ATTRIBUTE",
                      &mx::InterfaceElement::NODE_DEF_ATTRIBUTE)
      .class_property("TARGET_ATTRIBUTE",
                      &mx::InterfaceElement::TARGET_ATTRIBUTE)
      .class_property("VERSION_ATTRIBUTE",
                      &mx::InterfaceElement::VERSION_ATTRIBUTE)
      .class_property("DEFAULT_VERSION_ATTRIBUTE",
                      &mx::InterfaceElement::DEFAULT_VERSION_ATTRIBUTE);
}
