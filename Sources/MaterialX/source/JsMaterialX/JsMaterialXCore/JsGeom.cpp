...
#define BIND_GEOMINFO_FUNC_INSTANCE(NAME, T)                                   \
  BIND_MEMBER_FUNC("setGeomPropValue" #NAME, mx::GeomInfo,                     \
                   setGeomPropValue<T>, 2, 3, stRef, const T &, stRef)
...
EMSCRIPTEN_BINDINGS(geom) {
  ...
  ems::class_<mx::GeomElement, ems::base<mx::Element>>("GeomElement")
      ...
      .class_property("COLLECTION_ATTRIBUTE",
                      &mx::GeomElement::COLLECTION_ATTRIBUTE);

  ems::class_<mx::GeomInfo, ems::base<mx::GeomElement>>("GeomInfo")
      .smart_ptr_constructor(
          "GeomInfo",
          &std::make_shared<mx::GeomInfo, mx::ElementPtr, const std::string &>)
      .smart_ptr<std::shared_ptr<const mx::GeomInfo>>("GeomInfo")
          BIND_MEMBER_FUNC("addGeomProp", mx::GeomInfo, addGeomProp, 0, 1,
                           stRef)
      ...
      .function("removeToken", &mx::GeomInfo::removeToken)
          BIND_GEOMINFO_FUNC_INSTANCE(Integer, int) BIND_GEOMINFO_FUNC_INSTANCE(
              Boolean, bool) BIND_GEOMINFO_FUNC_INSTANCE(Float, float)
              BIND_GEOMINFO_FUNC_INSTANCE(
                  Color3, mx::Color3) BIND_GEOMINFO_FUNC_INSTANCE(Color4,
                                                                  mx::Color4)
                  BIND_GEOMINFO_FUNC_INSTANCE(
                      Vector2,
                      mx::Vector2) BIND_GEOMINFO_FUNC_INSTANCE(Vector3,
                                                               mx::Vector3)
                      BIND_GEOMINFO_FUNC_INSTANCE(
                          Vector4,
                          mx::Vector4) BIND_GEOMINFO_FUNC_INSTANCE(Matrix33,
                                                                   mx::Matrix33)
                          BIND_GEOMINFO_FUNC_INSTANCE(Matrix44, mx::Matrix44)
                              BIND_GEOMINFO_FUNC_INSTANCE(String, std::string)
                                  BIND_GEOMINFO_FUNC_INSTANCE(IntegerArray,
                                                              mx::IntVec)
                                      BIND_GEOMINFO_FUNC_INSTANCE(BooleanArray,
                                                                  mx::BoolVec)
                                          BIND_GEOMINFO_FUNC_INSTANCE(
                                              FloatArray, mx::FloatVec)
                                              BIND_GEOMINFO_FUNC_INSTANCE(
                                                  StringArray, mx::StringVec)
  ...
  ems::class_<mx::GeomProp, ems::base<mx::ValueElement>>("GeomProp")
      .smart_ptr_constructor(
          "GeomProp",
          &std::make_shared<mx::GeomProp, mx::ElementPtr, const std::string &>)
  ...
  ems::class_<mx::GeomPropDef, ems::base<mx::Element>>("GeomPropDef")
      .smart_ptr_constructor("GeomPropDef",
                             &std::make_shared<mx::GeomPropDef, mx::ElementPtr,
                                               const std::string &>)
      ...
      .class_property("GEOM_PROP_ATTRIBUTE",
                      &mx::GeomPropDef::GEOM_PROP_ATTRIBUTE)
  ...
  ems::class_<mx::Collection, ems::base<mx::Element>>("Collection")
      .smart_ptr_constructor("Collection",
                             &std::make_shared<mx::Collection, mx::ElementPtr,
                                               const std::string &>)
      ...
      .function("setIncludeCollectionString",
                &mx::Collection::setIncludeCollectionString)
      .function("hasIncludeCollectionString",
                &mx::Collection::hasIncludeCollectionString)
      .function("getIncludeCollectionString",
                &mx::Collection::getIncludeCollectionString)
      ...
      .class_property("INCLUDE_GEOM_ATTRIBUTE",
                      &mx::Collection::INCLUDE_GEOM_ATTRIBUTE)
      .class_property("EXCLUDE_GEOM_ATTRIBUTE",
                      &mx::Collection::EXCLUDE_GEOM_ATTRIBUTE)
      .class_property("INCLUDE_COLLECTION_ATTRIBUTE",
                      &mx::Collection::INCLUDE_COLLECTION_ATTRIBUTE);
