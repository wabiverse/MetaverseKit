...
EMSCRIPTEN_BINDINGS(node) {
  ems::class_<mx::Node, ems::base<mx::InterfaceElement>>("Node")
      .smart_ptr_constructor(
          "Node",
          &std::make_shared<mx::Node, mx::ElementPtr, const std::string &>)
      ...
      .function("getConnectedOutput", &mx::Node::getConnectedOutput)
          BIND_MEMBER_FUNC("getNodeDef", mx::Node, getNodeDef, 0, 1, stRef)
              BIND_MEMBER_FUNC("getImplementation", mx::Node, getImplementation,
                               0, 1, stRef)
  ...
  ems::class_<mx::GraphElement, ems::base<mx::InterfaceElement>>("GraphElement")
      ...
      .smart_ptr<std::shared_ptr<const mx::GraphElement>>("GraphElement")
          BIND_MEMBER_FUNC("addNode", mx::GraphElement, addNode, 1, 3, stRef,
                           stRef, stRef)
              BIND_MEMBER_FUNC("addNodeInstance", mx::GraphElement,
                               addNodeInstance, 1, 2, mx::ConstNodeDefPtr,
                               stRef)
      ...
      .function("removeNode", &mx::GraphElement::removeNode)
          BIND_MEMBER_FUNC("addMaterialNode", mx::GraphElement, addMaterialNode,
                           0, 2, stRef, mx::ConstNodePtr)
      .function("getMaterialNodes", &mx::GraphElement::getMaterialNodes)
          BIND_MEMBER_FUNC("addBackdrop", mx::GraphElement, addBackdrop, 0, 1,
                           stRef)
      ...
      .function("removeBackdrop", &mx::GraphElement::removeBackdrop)
          BIND_MEMBER_FUNC("flattenSubgraphs", mx::GraphElement,
                           flattenSubgraphs, 0, 2, stRef, mx::NodePredicate)
  ...
  ems::class_<mx::NodeGraph, ems::base<mx::GraphElement>>("NodeGraph")
      .smart_ptr_constructor(
          "NodeGraph",
          &std::make_shared<mx::NodeGraph, mx::ElementPtr, const std::string &>)
  ...
  ems::class_<mx::Backdrop, ems::base<mx::Element>>("Backdrop")
      .smart_ptr_constructor(
          "Backdrop",
          &std::make_shared<mx::Backdrop, mx::ElementPtr, const std::string &>)
