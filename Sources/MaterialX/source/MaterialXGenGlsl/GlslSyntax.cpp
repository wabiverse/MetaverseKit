...
GlslSyntax::GlslSyntax() {
  ...
  registerTypeSyntax(Type::COLOR3,
                     std::make_shared<AggregateTypeSyntax>(
                         "vec3", "vec3(0.0)", "vec3(0.0)", EMPTY_STRING,
                         EMPTY_STRING, VEC3_MEMBERS));

  registerTypeSyntax(Type::COLOR4,
                     std::make_shared<AggregateTypeSyntax>(
                         "vec4", "vec4(0.0)", "vec4(0.0)", EMPTY_STRING,
                         EMPTY_STRING, VEC4_MEMBERS));

  registerTypeSyntax(Type::VECTOR2,
                     std::make_shared<AggregateTypeSyntax>(
                         "vec2", "vec2(0.0)", "vec2(0.0)", EMPTY_STRING,
                         EMPTY_STRING, VEC2_MEMBERS));
  ...
  registerTypeSyntax(Type::MATRIX33, std::make_shared<AggregateTypeSyntax>(
                                         "mat3", "mat3(1.0)", "mat3(1.0)"));

  registerTypeSyntax(Type::MATRIX44, std::make_shared<AggregateTypeSyntax>(
                                         "mat4", "mat4(1.0)", "mat4(1.0)"));

  registerTypeSyntax(Type::STRING, std::make_shared<GlslStringTypeSyntax>());
  ...
  registerTypeSyntax(Type::BSDF,
                     std::make_shared<AggregateTypeSyntax>(
                         "BSDF", "BSDF(vec3(0.0),vec3(1.0), 0.0, 0.0)",
                         EMPTY_STRING, EMPTY_STRING,
                         "struct BSDF { vec3 response; vec3 throughput; float "
                         "thickness; float ior; };"));

  registerTypeSyntax(Type::EDF, std::make_shared<AggregateTypeSyntax>(
                                    "EDF", "EDF(0.0)", "EDF(0.0)", "vec3",
                                    "#define EDF vec3"));

  registerTypeSyntax(
      Type::VDF,
      std::make_shared<AggregateTypeSyntax>(
          "BSDF", "BSDF(vec3(0.0),vec3(1.0), 0.0, 0.0)", EMPTY_STRING));

  registerTypeSyntax(
      Type::SURFACESHADER,
      std::make_shared<AggregateTypeSyntax>(
          "surfaceshader", "surfaceshader(vec3(0.0),vec3(0.0))", EMPTY_STRING,
          EMPTY_STRING,
  ...
  registerTypeSyntax(
      Type::VOLUMESHADER,
      std::make_shared<AggregateTypeSyntax>(
          "volumeshader", "volumeshader(vec3(0.0),vec3(0.0))", EMPTY_STRING,
          EMPTY_STRING,
  ...
  registerTypeSyntax(
      Type::LIGHTSHADER,
      std::make_shared<AggregateTypeSyntax>(
          "lightshader", "lightshader(vec3(0.0),vec3(0.0))", EMPTY_STRING,
          EMPTY_STRING,
          "struct lightshader { vec3 intensity; vec3 direction; };"));

  registerTypeSyntax(Type::MATERIAL,
                     std::make_shared<AggregateTypeSyntax>(
                         "material", "material(vec3(0.0),vec3(0.0))",
                         EMPTY_STRING, "surfaceshader",
...
bool GlslSyntax::remapEnumeration(
