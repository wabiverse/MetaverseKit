...
void LightShaderNodeGlsl::initialize(const InterfaceElement &element,
                                     GenContext &context) {
...
void LightShaderNodeGlsl::createVariables(const ShaderNode &,
                                          GenContext &context,
                                          Shader &shader) const {
...
void LightShaderNodeGlsl::emitFunctionCall(const ShaderNode &,
                                           GenContext &context,
