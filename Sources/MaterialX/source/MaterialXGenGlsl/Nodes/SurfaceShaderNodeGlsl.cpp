...
void SurfaceShaderNodeGlsl::createVariables(const ShaderNode &,
                                            GenContext &context,
                                            Shader &shader) const {
  // TODO:
  ...
  // implementation can be set to depend on the PositionNodeGlsl,
...
void SurfaceShaderNodeGlsl::emitFunctionCall(const ShaderNode &node,
                                             GenContext &context,
