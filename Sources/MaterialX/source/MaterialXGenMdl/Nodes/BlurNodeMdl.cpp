...
void BlurNodeMdl::outputSampleArray(const ShaderGenerator &shadergen,
                                    ShaderStage &stage,
  ...
  shadergen.emitLine(arrayDeclaration + " " + sampleName + " = " +
                         arrayDeclaration,
                     stage, false);
...
// No definitions needed for blur in MDL so override the base class with an
// empty function definition emitter.
void BlurNodeMdl::emitSamplingFunctionDefinition(const ShaderNode &,
                                                 GenContext &,
                                                 ShaderStage &) const {}

void BlurNodeMdl::emitFunctionCall(const ShaderNode &node, GenContext &context,
