...
void CompoundNode::initialize(const InterfaceElement &element,
                              GenContext &context) {
...
void CompoundNode::createVariables(const ShaderNode &, GenContext &context,
                                   Shader &shader) const {
...
void CompoundNode::emitFunctionDefinition(const ShaderNode &,
                                          GenContext &context,
...
void CompoundNode::emitFunctionCall(const ShaderNode &node, GenContext &context,
                                    ShaderStage &stage) const {
  const ShaderGenerator &shadergen = context.getShaderGenerator();
