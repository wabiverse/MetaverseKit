...
void PositionNodeMsl::createVariables(const ShaderNode &node, GenContext &,
                                      Shader &shader) const {
  ...
  if (space == WORLD_SPACE) {
    ...
    addStageConnector(HW::VERTEX_DATA, Type::VECTOR3, HW::T_POSITION_OBJECT, vs,
                      ps);
  }
}

void PositionNodeMsl::emitFunctionCall(const ShaderNode &node,
                                       GenContext &context,
