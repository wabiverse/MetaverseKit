...
MslSyntax::MslSyntax() {
  ...
  registerTypeSyntax(Type::STRING, std::make_shared<MslStringTypeSyntax>());

  registerTypeSyntax(Type::FILENAME,
                     std::make_shared<ScalarTypeSyntax>(
                         "MetalTexture", EMPTY_STRING, EMPTY_STRING));

  registerTypeSyntax(Type::BSDF,
                     std::make_shared<AggregateTypeSyntax>(
                         "BSDF", "BSDF{float3(0.0),float3(1.0), 0.0, 0.0}",
  ...
  registerTypeSyntax(
      Type::SURFACESHADER,
      std::make_shared<AggregateTypeSyntax>(
          "surfaceshader", "surfaceshader{float3(0.0),float3(0.0)}",
          EMPTY_STRING, EMPTY_STRING,
  ...
  registerTypeSyntax(
      Type::VOLUMESHADER,
      std::make_shared<AggregateTypeSyntax>(
          "volumeshader", "volumeshader{float3(0.0),float3(0.0)}", EMPTY_STRING,
          EMPTY_STRING,
  ...
  registerTypeSyntax(
      ...
      std::make_shared<AggregateTypeSyntax>(
          "displacementshader", "displacementshader{float3(0.0),1.0}",
          EMPTY_STRING, EMPTY_STRING,
  ...
  registerTypeSyntax(
      Type::LIGHTSHADER,
      std::make_shared<AggregateTypeSyntax>(
          "lightshader", "lightshader{float3(0.0),float3(0.0)}", EMPTY_STRING,
          EMPTY_STRING,
          "struct lightshader { float3 intensity; float3 direction; };"));

  registerTypeSyntax(Type::MATERIAL,
                     std::make_shared<AggregateTypeSyntax>(
                         "material", "material{float3(0.0),float3(0.0)}",
...
bool MslSyntax::remapEnumeration(
