...
// for the default backends files (ImGui/impl_xxx.h) Using dear imgui via a
...
// string type, see misc/cpp/ImGui/stdlib.h and comments in ImGui/demo.cpp.
...
// - See Demo->Tables for demo code. See top of ImGui/tables.cpp for general
// commentary.
...
enum ImGuiWindowFlags_ {
  ...
  ImGuiWindowFlags_HorizontalScrollbar =
      1 << 11, // Allow horizontal scrollbar to appear (off by default). You may
               ...
               // calling Begin() to specify width. Read code in ImGui/demo in
...
enum ImGuiInputTextFlags_ {
  ...
  ImGuiInputTextFlags_CallbackResize =
      1 << 18, // Callback on buffer capacity changes request (beyond 'buf_size'
               ...
               // misc/cpp/ImGui/stdlib.h for an example of using this)
...
//      meaningful again.
// - Read on documentation at the top of ImGui/tables.cpp for details.
...
// Backend capabilities flags stored in io.BackendFlags. Set by ImGui/impl_xxx
// or custom backend.
...
// Flags for InvisibleButton() [extended in ImGui/Internal.h]
...
// available in ImGui/ImGui.h because some of our public structures are relying
// on it.
...
struct ImGuiIO {
  ...
  ImGuiBackendFlags
      BackendFlags;   // = 0              // See ImGuiBackendFlags_ enum. Set by
                      // backend (ImGui/impl_xxx files or custom backend) to
  ...
  const char
      *LogFilename; // = "ImGui/log.txt"// Path to .log file (default parameter
  ...
  // ImOsIsDebuggerPresent() in ImGui/test_engine/ImGui/te_utils.cpp for a Unix
  // compatible version).
  ...
  //------------------------------------------------------------------
  // Platform Functions
  // (the ImGui/impl_xxxx backend files are setting those up for you)
  //------------------------------------------------------------------
...
// Include ImGui/user.h at the end of ImGui/ImGui.h (convenient for user to only
// explicitly include vanilla ImGui/ImGui.h)
