...
// [SECTION] Test Engine specific hooks (ImGui/test_engine)
...
// "ImGui/Internal.h" in ImGui/ImGui.h As they are frequently requested, we do
// not want to encourage to many people using "ImGui/Internal.h"
#if defined(IMGUI_DEFINE_MATH_OPERATORS) &&                                    \
    !defined(IMGUI_DEFINE_MATH_OPERATORS_IMPLEMENTED)
#error Please '#define IMGUI_DEFINE_MATH_OPERATORS' _BEFORE_ including ImGui/ImGui.h!
#endif
...
// Helpers: Maths
IM_MSVC_RUNTIME_CHECKS_OFF
// - Wrapper for standard libs functions. (Note that ImGui/demo.cpp does _not_
...
enum ImGuiInputFlags_ {
  ...
  ImGuiInputFlags_Repeat = 1 << 0, // Return true on successive repeats. Default
...
struct IMGUI_API ImGuiWindow {
  ...
  ImDrawList
      *DrawList; // == &DrawListInst (for backward compatibility reason with
                 // code using "ImGui/Internal.h" we keep this a pointer)
...
// Template functions are instantiated in ImGui/widgets.cpp for a finite number
