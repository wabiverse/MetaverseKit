...
//  from Impla5.cpp to Implallegro5.cpp. 2018-04-18: Misc: Added
//  support for 32-bit vertex indices to avoid conversion at runtime. Added
//  imconfig_allegro5.h to enforce 32-bit indices when included from
//  ImGui/ImGui.h. 2018-02-16: Misc: Obsoleted the io.RenderDrawListsFn callback
//  and exposed ImGui_ImplAllegro5_RenderDrawData() in the .h file so you can
...
bool ImGui_ImplAllegro5_Init(ALLEGRO_DISPLAY *display) {
  ...
  io.BackendPlatformName = io.BackendRendererName = "Implallegro5";
  io.BackendFlags |=
