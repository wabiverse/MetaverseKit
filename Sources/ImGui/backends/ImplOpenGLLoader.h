...
// enums/functions that we use in our Implopengl3.cpp source file in
// order to be small.
//
// YOU SHOULD NOT NEED TO INCLUDE/USE THIS DIRECTLY. THIS IS USED BY
// Implopengl3.cpp ONLY. THE REST OF YOUR APP SHOULD USE A DIFFERENT GL
...
// 'Implopengl3.cpp' OR INCUDING 'Implopengl3_loader.h' IN THE
...
// IMGUI_IMPL_OPENGL_LOADER_CUSTOM' and Implopengl3.cpp WILL NOT BE USING
// OUR LOADER, AND INSTEAD EXPECT ANOTHER/YOUR LOADER TO BE AVAILABLE IN THE
// COMPILATION UNIT.
//
// Regenerate with:
//   python gl3w_gen.py --output ../imgui/backends/Implopengl3_loader.h
//   --ref ../imgui/backends/Implopengl3.cpp ./extra_symbols.txt
//
// More info:
