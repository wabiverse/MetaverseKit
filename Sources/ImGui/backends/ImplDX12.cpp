...
//  2018-06-08: Misc: Extracted Impldx12.cpp/.h away from the old
...
static void ImGui_ImplDX12_CreateFontsTexture() {
  ...
  // Definitions" add 'IMGUI_USER_CONFIG="my_ImGui/config.h"' and inside
  // 'my_ImGui/config.h' add '#define ImTextureID ImU64' and as many other
...
bool ImGui_ImplDX12_Init(ID3D12Device *device, int num_frames_in_flight,
  ...
  io.BackendRendererName = "Impldx12";
  io.BackendFlags |=
