...
// be available for reference. Thank you, -Your beloved friend, ImGui/demo.cpp
...
//   by ImGui/ImGui.h using the IMGUI_DEFINE_MATH_OPERATORS define. For your own
...
// Helpers macros
// We normally try to not use many helpers in ImGui/demo.cpp in order to make
...
// functions from ImGui/Internal.h (ImMin/ImMax) but not in the demo.
...
void ImGui::ShowDemoWindow(bool *p_open) {
  ...
  if (ImGui::BeginMenuBar()) {
    ...
    if (ImGui::BeginMenu("Tools")) {
      ...
      ImGui::MenuItem("Stack Tool", NULL, &show_tool_stack_tool,
                      has_debug_tools);
  ...
  if (ImGui::CollapsingHeader("Help")) {
    ...
    ImGui::BulletText(
        "See the ShowDemoWindow() code in ImGui/demo.cpp. <- you are here!");
  ...
  if (ImGui::CollapsingHeader("Configuration")) {
    ...
    if (ImGui::TreeNode("Backend Flags")) {
      HelpMarker("Those flags are set by the backends (ImGui/impl_xxx files) "
...
static void ShowDemoWindowWidgets() {
  ...
  if (ImGui::TreeNode("Basic")) {
...

    {
      ...
      HelpMarker("USER:\n"
                 ...
                 "to a dynamic string type. See misc/cpp/ImGui/stdlib.h for an "
  ...
  if (ImGui::TreeNode("Images")) {
    ...
    // If you use one of the default ImGui/impl_XXXX.cpp rendering backend, they
    ...
    // - The ImGui/impl_dx11.cpp renderer expect a 'ID3D11ShaderResourceView*'
    // pointer
    // - The ImGui/impl_opengl3.cpp renderer expect a GLuint OpenGL texture
    // identifier, etc. More:
  ...
  if (ImGui::TreeNode("Text Input")) {
    ...
    if (ImGui::TreeNode("Multi-line Text Input")) {
      ...
      // misc/cpp/ImGui/stdlib.h for how to setup InputText() for dynamically
      // resizing strings.
      ...
      HelpMarker("You can use the ImGuiInputTextFlags_CallbackResize facility "
                 ...
                 "type. See misc/cpp/ImGui/stdlib.h for an example. (This is "
                 "not demonstrated in ImGui/demo.cpp because we don't want to "
    ...
    if (ImGui::TreeNode("Resize Callback")) {
      ...
      // misc/cpp/ImGui/stdlib.h for an implementation of this using
      // std::string.
      HelpMarker("Using ImGuiInputTextFlags_CallbackResize to wire your custom "
                 "string type to InputText().\n\n"
                 "See misc/cpp/ImGui/stdlib.h for an implementation of this "
                 "for std::string.");
      struct Funcs {
