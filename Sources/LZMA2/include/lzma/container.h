...
#ifndef LZMA_API_CONTAINER_H
#define LZMA_API_CONTAINER_H
 ...
 */
extern LZMA_API(lzma_ret)
    lzma_microlzma_encoder(lzma_stream *strm,
                           const lzma_options_lzma *options) lzma_nothrow;
 ...
 */
extern LZMA_API(lzma_ret)
    lzma_lzip_decoder(lzma_stream *strm, uint64_t memlimit,
                      uint32_t flags) lzma_nothrow lzma_attr_warn_unused_result;
