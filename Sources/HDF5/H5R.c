...
static h5_posix_io_ret_t H5R_get_name(H5F_t *file, hid_t lapl_id, hid_t dxpl_id, hid_t id,
...
--------------------------------------------------------------------------*/
hid_t H5R_dereference(H5F_t *file, hid_t oapl_id, hid_t dxpl_id, H5R_type_t ref_type, const void *_ref, hbool_t app_ref)
{
...
/*--------------------------------------------------------------------------
 ...
 REVISION LOG
    ...
    supports dataset access property list currently.
--------------------------------------------------------------------------*/
hid_t H5Rdereference2(hid_t obj_id, hid_t oapl_id, H5R_type_t ref_type, const void *_ref)
{
  H5G_loc_t loc;                         /* Group location */
...
/*--------------------------------------------------------------------------
 ...
 USAGE
    h5_posix_io_ret_t H5R_get_name(f, dxpl_id, ref_type, ref, name, size)
...
/*--------------------------------------------------------------------------
 ...
 USAGE
    h5_posix_io_ret_t H5Rget_name(loc_id, ref_type, ref, name, size)
