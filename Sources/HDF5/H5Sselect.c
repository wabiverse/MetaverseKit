...
H5S_select_shape_same(const H5S_t *space1, const H5S_t *space2)
{
  ...
  else
  {
    ...
    else if ((H5S_GET_SELECT_TYPE(space_a) == H5S_SEL_HYPERSLABS && space_a->select.sel_info.hslab->diminfo_valid) && (H5S_GET_SELECT_TYPE(space_b) == H5S_SEL_HYPERSLABS && space_b->select.sel_info.hslab->diminfo_valid))
    {
      int space_a_dim; /* Current dimension in dataspace A */
      int space_b_dim; /* Current dimension in dataspace B */
                                ...
                                unsigned new_space_rank, const void *buf, void const **adj_buf_ptr, hsize_t element_size)
{
  ...
  {                                          /* projected space must be simple */
    ...
    { /* new_space_rank < base_space_rank */
                                ...
                                const H5S_t *src_intersect_space, H5S_t **new_space_ptr)
{
  ...
  else if ((src_intersect_space->select.type->type == H5S_SEL_NONE) || (src_space->select.type->type == H5S_SEL_NONE) || (dst_space->select.type->type == H5S_SEL_NONE))
  {
   ...
   */
  else if ((src_intersect_space->select.type->type == H5S_SEL_POINTS) || (src_space->select.type->type == H5S_SEL_POINTS) || (dst_space->select.type->type == H5S_SEL_POINTS))
