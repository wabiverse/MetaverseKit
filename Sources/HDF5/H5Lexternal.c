...
static h5_posix_io_ret_t H5L_extern_query(const char H5_ATTR_UNUSED *link_name, const void *udata,
                    ...
                    const void *_udata, size_t H5_ATTR_UNUSED udata_size, hid_t lapl_id)
{
  ...
  if (cb_info.func)
  {
    ...
    h5_posix_io_ret_t group_name_len;       /* Length of parent group name */
                 ...
                 void *buf /*out*/, size_t buf_size)
{
  ...
  h5_posix_io_ret_t ret_value = SUCCEED;                    /* Return value */
  ...
  /* Set return value */
  ret_value = (h5_posix_io_ret_t)udata_size;
