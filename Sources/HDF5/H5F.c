...
H5Fget_obj_count(hid_t file_id, unsigned types)
{
  ...
  ret_value = (h5_posix_io_ret_t)obj_count;
 ...
 *              Raymond Lu
 *              24 September 2008
 *              Changed the return value to h5_posix_io_ret_t and MAX_OBJTS to size_t to
...
H5Fget_obj_ids(hid_t file_id, unsigned types, size_t max_objs, hid_t *oid_list)
{
  ...
  /* Set the return value */
  ret_value = (h5_posix_io_ret_t)obj_id_count;
