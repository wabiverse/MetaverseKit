...
static herr_t H5D__contig_io_init(const H5D_io_info_t *io_info, const H5D_type_info_t *type_info,
                                  ...
                                  H5D_chunk_map_t *cm);
static h5_posix_io_ret_t H5D__contig_readvv(const H5D_io_info_t *io_info,
                                            size_t dset_max_nseq, size_t *dset_curr_seq, size_t dset_len_arr[], hsize_t dset_offset_arr[],
                                            size_t mem_max_nseq, size_t *mem_curr_seq, size_t mem_len_arr[], hsize_t mem_offset_arr[]);
static h5_posix_io_ret_t H5D__contig_writevv(const H5D_io_info_t *io_info,
                                             size_t dset_max_nseq, size_t *dset_curr_seq, size_t dset_len_arr[], hsize_t dset_offset_arr[],
                                             size_t mem_max_nseq, size_t *mem_curr_seq, size_t mem_len_arr[], hsize_t mem_offset_arr[]);
...
const H5D_layout_ops_t H5D_LOPS_CONTIG[1] = {{H5D__contig_construct,
                                              H5D__contig_init,
...
H5D__contig_writevv(const H5D_io_info_t *io_info,
                    ...
                    size_t mem_max_nseq, size_t *mem_curr_seq, size_t mem_len_arr[], hsize_t mem_off_arr[])
{
  h5_posix_io_ret_t ret_value = -1; /* Return value (Size of sequence in bytes) */
