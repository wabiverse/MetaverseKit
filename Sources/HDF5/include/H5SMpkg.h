...
#define H5SM_TABLE_SIZE(f) (/* General metadata fields */ \
                            H5SM_METADATA_PREFIX_SIZE     \
                                                          \
                            /* Indices */                 \
                            + (H5F_SOHM_NINDEXES(f) * H5SM_INDEX_HEADER_SIZE(f)))

#define H5SM_LIST_SIZE(f, num_mesg) (/* General metadata fields */ \
                                     H5SM_METADATA_PREFIX_SIZE     \
                                                                   \
                                     /* Message entries */         \
...
/* General routines */
H5_DLL h5_posix_io_ret_t H5SM_get_index(const H5SM_master_table_t *table, unsigned type_id);
