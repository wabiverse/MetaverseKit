...
extern "C"
{
  ...
  H5_DLL h5_posix_io_ret_t H5Oget_comment(hid_t obj_id, char *comment, size_t bufsize);
  H5_DLL h5_posix_io_ret_t H5Oget_comment_by_name(hid_t loc_id, const char *name,
