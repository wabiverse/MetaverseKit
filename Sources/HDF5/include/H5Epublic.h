...
extern "C"
{
  ...
  H5_DLL h5_posix_io_ret_t H5Eget_class_name(hid_t class_id, char *name, size_t size);
  ...
  H5_DLL h5_posix_io_ret_t H5Eget_msg(hid_t msg_id, H5E_type_t *type, char *msg,
                                      size_t size);
  H5_DLL h5_posix_io_ret_t H5Eget_num(hid_t error_stack_id);
