...
typedef h5_posix_io_ret_t (*H5T_vlen_getlenfunc_t)(const void *vl_addr);
...
H5_DLL herr_t H5T__bit_shift(uint8_t *buf, h5_posix_io_ret_t shift_dist, size_t offset, size_t size);
...
H5_DLL void H5T__bit_set_d(uint8_t *buf, size_t offset, size_t size,
                           uint64_t val);
H5_DLL h5_posix_io_ret_t H5T__bit_find(uint8_t *buf, size_t offset, size_t size,
