...
extern "C"
{
  ...
  H5_DLL h5_posix_io_ret_t H5Fget_obj_count(hid_t file_id, unsigned types);
  H5_DLL h5_posix_io_ret_t H5Fget_obj_ids(hid_t file_id, unsigned types, size_t max_objs, hid_t *obj_id_list);
  H5_DLL herr_t H5Fget_vfd_handle(hid_t file_id, hid_t fapl, void **file_handle);
  H5_DLL herr_t H5Fmount(hid_t loc, const char *name, hid_t child, hid_t plist);
  H5_DLL herr_t H5Funmount(hid_t loc, const char *name);
  H5_DLL hssize_t H5Fget_freespace(hid_t file_id);
  H5_DLL herr_t H5Fget_filesize(hid_t file_id, hsize_t *size);
  H5_DLL h5_posix_io_ret_t H5Fget_file_image(hid_t file_id, void *buf_ptr, size_t buf_len);
  ...
  H5_DLL h5_posix_io_ret_t H5Fget_name(hid_t obj_id, char *name, size_t size);
  ...
  H5_DLL h5_posix_io_ret_t H5Fget_free_sections(hid_t file_id, H5F_mem_t type,
