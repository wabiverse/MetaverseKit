...
extern "C"
{
  ...
  H5_DLL h5_posix_io_ret_t H5Aget_name(hid_t attr_id, size_t buf_size, char *buf);
  H5_DLL h5_posix_io_ret_t H5Aget_name_by_idx(hid_t loc_id, const char *obj_name,
