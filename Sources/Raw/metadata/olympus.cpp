...
void LibRaw::setOlympusBodyFeatures(unsigned long long id) {
  ...
  if ((id == OlyID_E_1) || (id == OlyID_E_300) ||
      ((id & 0x00ffff0000ULL) == 0x0030300000ULL)) {
    ilm.CameraFormat = LIBRAW_FORMAT_FT;

    if ((id == OlyID_E_1) || (id == OlyID_E_300) ||
        ((id >= OlyID_E_330) && (id <= OlyID_E_520)) || (id == OlyID_E_620) ||
        (id == OlyID_E_450) || (id == OlyID_E_600) || (id == OlyID_E_5)) {
...
void LibRaw::getOlympus_SensorTemperature(unsigned len) {
  if (OlyID != 0x0ULL) {
    short temp = get2();
    if ((OlyID == OlyID_E_1) || (OlyID == OlyID_E_M5) || (len != 1))
...
void LibRaw::parseOlympus_Equipment(unsigned tag, unsigned /*type */,
...
void LibRaw::parseOlympus_ImageProcessing(unsigned tag, unsigned type,
  ...
  if ((tag == 0x0100) && (dng_writer == nonDNG)) {
    ...
    if (icWBC[LIBRAW_WBI_Flash][0])
      icWBC[LIBRAW_WBI_Flash][1] = icWBC[LIBRAW_WBI_Flash][3] = wbG;
    FORC4 if (icWBC[LIBRAW_WBI_Custom1 + c][0])
        icWBC[LIBRAW_WBI_Custom1 + c][1] = icWBC[LIBRAW_WBI_Custom1 + c][3] =
            wbG;
  } else if (tag == 0x0121) {
...
void LibRaw::parseOlympus_RawInfo(unsigned tag, unsigned /*type */,
                                  unsigned len, unsigned dng_writer) {
  // uptag 0x3000
...
void LibRaw::parseOlympusMakernotes(int base, unsigned tag, unsigned type,
                                    unsigned len, unsigned dng_writer) {
  ...
  if ((tag >= 0x20100000) && (tag <= 0x2010ffff)) {
    ...
    switch (tag) {
    case 0x0200:
      FORC3 if ((imOly.SpecialMode[c] = get4()) >= 0xff) imOly.SpecialMode[c] =
          0xffffffff;
      break;
    case 0x0207:
      getOlympus_CameraType2();
