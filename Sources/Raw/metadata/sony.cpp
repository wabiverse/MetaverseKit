...
void LibRaw::setSonyBodyFeatures(unsigned long long id) {
  static const struct {
    ...
    */
      ...
      {SonyID_DSLR_A100, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Minolta_A,
       LIBRAW_SONY_DSLR, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010None, 0xffff,
       0xffff, 0xffff, 0xffff, 0xffff},
      {SonyID_DSLR_A900, LIBRAW_FORMAT_FF, LIBRAW_MOUNT_Minolta_A,
       LIBRAW_SONY_DSLR, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010None, 0xffff,
       0xffff, 0xffff, 0xffff, 0xffff},
      {SonyID_DSLR_A700, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Minolta_A,
       LIBRAW_SONY_DSLR, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010None, 0xffff,
       0xffff, 0xffff, 0xffff, 0xffff},
      {SonyID_DSLR_A200, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Minolta_A,
       LIBRAW_SONY_DSLR, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010None, 0xffff,
       0xffff, 0xffff, 0xffff, 0xffff},
      {SonyID_DSLR_A350, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Minolta_A,
       LIBRAW_SONY_DSLR, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010None, 0xffff,
       0xffff, 0xffff, 0xffff, 0xffff},
      {SonyID_DSLR_A300, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Minolta_A,
       LIBRAW_SONY_DSLR, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010None, 0xffff,
       0xffff, 0xffff, 0xffff, 0xffff},
      {SonyID_DSLR_A900, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Minolta_A,
       LIBRAW_SONY_DSLR, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010None, 0xffff,
       0xffff, 0xffff, 0xffff, 0xffff},
      {SonyID_DSLR_A380, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Minolta_A,
       LIBRAW_SONY_DSLR, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010None, 0xffff,
       0xffff, 0xffff, 0xffff, 0xffff},
      {SonyID_DSLR_A330, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Minolta_A,
       LIBRAW_SONY_DSLR, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010None, 0xffff,
       0xffff, 0xffff, 0xffff, 0xffff},
      {SonyID_DSLR_A230, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Minolta_A,
       LIBRAW_SONY_DSLR, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010None, 0xffff,
       0xffff, 0xffff, 0xffff, 0xffff},
      {SonyID_DSLR_A290, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Minolta_A,
       LIBRAW_SONY_DSLR, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010None, 0xffff,
       0xffff, 0xffff, 0xffff, 0xffff},
      {SonyID_DSLR_A850, LIBRAW_FORMAT_FF, LIBRAW_MOUNT_Minolta_A,
       LIBRAW_SONY_DSLR, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010None, 0xffff,
       0xffff, 0xffff, 0xffff, 0xffff},
      {SonyID_DSLR_A850, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Minolta_A,
       LIBRAW_SONY_DSLR, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010None, 0xffff,
       0xffff, 0xffff, 0xffff, 0xffff},
      {SonyID_DSLR_A550, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Minolta_A,
       LIBRAW_SONY_DSLR, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010None, 0xffff,
       0xffff, 0xffff, 0xffff, 0xffff},
      {SonyID_DSLR_A500, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Minolta_A,
       LIBRAW_SONY_DSLR, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010None, 0xffff,
       0xffff, 0xffff, 0xffff, 0xffff},
      {SonyID_DSLR_A450, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Minolta_A,
       LIBRAW_SONY_DSLR, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010None, 0xffff,
       0xffff, 0xffff, 0xffff, 0xffff},
      {SonyID_NEX_5, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Sony_E, LIBRAW_SONY_NEX,
       LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010None, 0xffff, 0xffff, 0xffff,
       0xffff, 0xffff},
      {SonyID_NEX_3, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Sony_E, LIBRAW_SONY_NEX,
       LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010None, 0xffff, 0xffff, 0xffff,
       0xffff, 0xffff},
      {SonyID_SLT_A33, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Minolta_A,
       LIBRAW_SONY_SLT, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010None, 0xffff,
       0xffff, 0xffff, 0xffff, 0xffff},
      {SonyID_SLT_A55, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Minolta_A,
       LIBRAW_SONY_SLT, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010None, 0xffff,
       0xffff, 0xffff, 0xffff, 0xffff},
      {SonyID_DSLR_A560, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Minolta_A,
       LIBRAW_SONY_DSLR, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010None, 0xffff,
       0xffff, 0xffff, 0xffff, 0xffff},
      {SonyID_DSLR_A580, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Minolta_A,
       LIBRAW_SONY_DSLR, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010None, 0xffff,
       0xffff, 0xffff, 0xffff, 0xffff},
      {SonyID_NEX_C3, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Sony_E, LIBRAW_SONY_NEX,
       LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010None, 0xffff, 0xffff, 0xffff,
       0xffff, 0xffff},
      {SonyID_SLT_A35, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Minolta_A,
       LIBRAW_SONY_SLT, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010None, 0xffff,
       0xffff, 0xffff, 0xffff, 0xffff},
      {SonyID_SLT_A65, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Minolta_A,
       LIBRAW_SONY_SLT, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010b, 0x1218,
       0x01bd, 0x1178, 0x1179, 0x112c},
      {SonyID_SLT_A77, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Minolta_A,
       LIBRAW_SONY_SLT, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010b, 0x1218,
       0x01bd, 0x1178, 0x1179, 0x112c},
      {SonyID_NEX_5N, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Sony_E, LIBRAW_SONY_NEX,
       LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010a, 0x113e, 0x01bd, 0x1174,
       0x1175, 0x112c},
      {SonyID_NEX_7, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Sony_E, LIBRAW_SONY_NEX,
       LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010b, 0x1218, 0x01bd, 0x1178,
       0x1179, 0x112c},
      {SonyID_NEX_VG20, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Sony_E,
       LIBRAW_SONY_NEX, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010b, 0x1218,
       0x01bd, 0x1178, 0x1179, 0x112c},
      {SonyID_SLT_A37, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Minolta_A,
       LIBRAW_SONY_SLT, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010c, 0x11f4,
       0x01bd, 0x1154, 0x1155, 0x1108},
      {SonyID_SLT_A57, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Minolta_A,
       LIBRAW_SONY_SLT, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010c, 0x11f4,
       0x01bd, 0x1154, 0x1155, 0x1108},
      {SonyID_NEX_F3, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Sony_E, LIBRAW_SONY_NEX,
       LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010c, 0x11f4, 0x01bd, 0x1154,
       0x1155, 0x1108},
      {SonyID_SLT_A99, LIBRAW_FORMAT_FF, LIBRAW_MOUNT_Minolta_A,
       LIBRAW_SONY_SLT, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010e, 0x1254,
       0x01aa, 0x11ac, 0x11ad, 0x1160},
      {SonyID_NEX_6, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Sony_E, LIBRAW_SONY_NEX,
       LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010e, 0x1254, 0x01aa, 0x11ac,
       0x11ad, 0x1160},
      {SonyID_NEX_5R, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Sony_E, LIBRAW_SONY_NEX,
       LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010e, 0x1254, 0x01aa, 0x11ac,
       0x11ad, 0x1160},
      {SonyID_DSC_RX100, LIBRAW_FORMAT_1INCH, LIBRAW_MOUNT_FixedLens,
       LIBRAW_SONY_DSC, LIBRAW_MOUNT_FixedLens, LIBRAW_SONY_Tag2010e, 0x1254,
       0xffff, 0x11ac, 0x11ad, 0x1160},
      {SonyID_DSC_RX1, LIBRAW_FORMAT_FF, LIBRAW_MOUNT_FixedLens,
       LIBRAW_SONY_DSC, LIBRAW_MOUNT_FixedLens, LIBRAW_SONY_Tag2010e, 0x1258,
       0xffff, 0x11ac, 0x11ad, 0x1160},
      {SonyID_NEX_VG900, LIBRAW_FORMAT_FF, LIBRAW_MOUNT_Sony_E, LIBRAW_SONY_NEX,
       LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010e, 0x1254, 0x01aa, 0x11ac,
       0x11ad, 0x1160},
      {SonyID_NEX_VG30, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Sony_E,
       LIBRAW_SONY_NEX, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010e, 0x1254,
       0x01aa, 0x11ac, 0x11ad, 0x1160},
      {SonyID_ILCE_3000, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Sony_E,
       LIBRAW_SONY_ILCE, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010e, 0x1280,
       0x01aa, 0x11ac, 0x11ad, 0x1160},
      {SonyID_SLT_A58, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Minolta_A,
       LIBRAW_SONY_SLT, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010e, 0x1280,
       0x01aa, 0x11ac, 0x11ad, 0x1160},
      {SonyID_NEX_3N, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Sony_E, LIBRAW_SONY_NEX,
       LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010e, 0x1280, 0x01aa, 0x11ac,
       0x11ad, 0x1160},
      {SonyID_ILCE_7, LIBRAW_FORMAT_FF, LIBRAW_MOUNT_Sony_E, LIBRAW_SONY_ILCE,
       LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010g, 0x0344, 0xffff, 0x025c,
       0x025d, 0x0210},
      {SonyID_NEX_5T, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Sony_E, LIBRAW_SONY_NEX,
       LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010e, 0x1254, 0x01aa, 0x11ac,
       0x11ad, 0x1160},
      {SonyID_DSC_RX100M2, LIBRAW_FORMAT_1INCH, LIBRAW_MOUNT_FixedLens,
       LIBRAW_SONY_DSC, LIBRAW_MOUNT_FixedLens, LIBRAW_SONY_Tag2010f, 0x113c,
       0xffff, 0x1064, 0x1065, 0x1018},
      {SonyID_DSC_RX10, LIBRAW_FORMAT_1INCH, LIBRAW_MOUNT_FixedLens,
       LIBRAW_SONY_DSC, LIBRAW_MOUNT_FixedLens, LIBRAW_SONY_Tag2010g, 0x0344,
       0xffff, 0x025c, 0x025d, 0x0210},
      {SonyID_DSC_RX1R, LIBRAW_FORMAT_FF, LIBRAW_MOUNT_FixedLens,
       LIBRAW_SONY_DSC, LIBRAW_MOUNT_FixedLens, LIBRAW_SONY_Tag2010e, 0x1258,
       0xffff, 0x11ac, 0x11ad, 0x1160},
      {SonyID_ILCE_7R, LIBRAW_FORMAT_FF, LIBRAW_MOUNT_Sony_E, LIBRAW_SONY_ILCE,
       LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010g, 0x0344, 0xffff, 0x025c,
       0x025d, 0x0210},
      {SonyID_ILCE_6000, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Sony_E,
       LIBRAW_SONY_ILCE, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010g, 0x0344,
       0xffff, 0x025c, 0x025d, 0x0210},
      {SonyID_ILCE_5000, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Sony_E,
       LIBRAW_SONY_ILCE, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010g, 0x0344,
       0x01aa, 0x025c, 0x025d, 0x0210},
      {SonyID_DSC_RX100M3, LIBRAW_FORMAT_1INCH, LIBRAW_MOUNT_FixedLens,
       LIBRAW_SONY_DSC, LIBRAW_MOUNT_FixedLens, LIBRAW_SONY_Tag2010g, 0x0344,
       0xffff, 0x025c, 0x025d, 0x0210},
      {SonyID_ILCE_7S, LIBRAW_FORMAT_FF, LIBRAW_MOUNT_Sony_E, LIBRAW_SONY_ILCE,
       LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010g, 0x0344, 0xffff, 0x025c,
       0x025d, 0x0210},
      {SonyID_ILCA_77M2, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Minolta_A,
       LIBRAW_SONY_ILCA, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010g, 0x0344,
       0x01a0, 0x025c, 0x025d, 0x0210},
      {SonyID_ILCE_5100, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Sony_E,
       LIBRAW_SONY_ILCE, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010g, 0x0344,
       0x01a0, 0x025c, 0x025d, 0x0210},
      {SonyID_ILCE_7M2, LIBRAW_FORMAT_FF, LIBRAW_MOUNT_Sony_E, LIBRAW_SONY_ILCE,
       LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010g, 0x0344, 0xffff, 0x025c,
       0x025d, 0x0210},
      {SonyID_DSC_RX100M4, LIBRAW_FORMAT_1INCH, LIBRAW_MOUNT_FixedLens,
       LIBRAW_SONY_DSC, LIBRAW_MOUNT_FixedLens, LIBRAW_SONY_Tag2010h, 0x0346,
       0xffff, 0x025c, 0x025d, 0x0210},
      {SonyID_DSC_RX10M2, LIBRAW_FORMAT_1INCH, LIBRAW_MOUNT_FixedLens,
       LIBRAW_SONY_DSC, LIBRAW_MOUNT_FixedLens, LIBRAW_SONY_Tag2010h, 0x0346,
       0xffff, 0x025c, 0x025d, 0x0210},
      {SonyID_DSC_RX1RM2, LIBRAW_FORMAT_FF, LIBRAW_MOUNT_FixedLens,
       LIBRAW_SONY_DSC, LIBRAW_MOUNT_FixedLens, LIBRAW_SONY_Tag2010h, 0x0346,
       0xffff, 0x025c, 0x025d, 0x0210},
      {SonyID_ILCE_QX1, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Sony_E,
       LIBRAW_SONY_ILCE, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010g, 0x0344,
       0x01a0, 0x025c, 0x025d, 0x0210},
      {SonyID_ILCE_7RM2, LIBRAW_FORMAT_FF, LIBRAW_MOUNT_Sony_E,
       LIBRAW_SONY_ILCE, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010h, 0x0346,
       0x01cb, 0x025c, 0x025d, 0x0210},
      {SonyID_ILCE_7SM2, LIBRAW_FORMAT_FF, LIBRAW_MOUNT_Sony_E,
       LIBRAW_SONY_ILCE, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010h, 0x0346,
       0x01cb, 0x025c, 0x025d, 0x0210},
      {SonyID_ILCA_68, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Minolta_A,
       LIBRAW_SONY_ILCA, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010g, 0x0344,
       0x01a0, 0x025c, 0x025d, 0x0210},
      {SonyID_ILCA_99M2, LIBRAW_FORMAT_FF, LIBRAW_MOUNT_Minolta_A,
       LIBRAW_SONY_ILCA, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010h, 0x0346,
       0x01cd, 0x025c, 0x025d, 0x0210},
      {SonyID_DSC_RX10M3, LIBRAW_FORMAT_1INCH, LIBRAW_MOUNT_FixedLens,
       LIBRAW_SONY_DSC, LIBRAW_MOUNT_FixedLens, LIBRAW_SONY_Tag2010h, 0x0346,
       0xffff, 0x025c, 0x025d, 0x0210},
      {SonyID_DSC_RX100M5, LIBRAW_FORMAT_1INCH, LIBRAW_MOUNT_FixedLens,
       LIBRAW_SONY_DSC, LIBRAW_MOUNT_FixedLens, LIBRAW_SONY_Tag2010h, 0x0346,
       0xffff, 0x025c, 0x025d, 0x0210},
      {SonyID_ILCE_6300, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Sony_E,
       LIBRAW_SONY_ILCE, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010h, 0x0346,
       0x01cd, 0x025c, 0x025d, 0x0210},
      {SonyID_ILCE_9, LIBRAW_FORMAT_FF, LIBRAW_MOUNT_Sony_E, LIBRAW_SONY_ILCE,
       LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010i, 0x0320, 0x019f, 0x024b,
       0x024c, 0x0208},
      {SonyID_ILCE_6500, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Sony_E,
       LIBRAW_SONY_ILCE, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010h, 0x0346,
       0x01cd, 0x025c, 0x025d, 0x0210},
      {SonyID_ILCE_7RM3, LIBRAW_FORMAT_FF, LIBRAW_MOUNT_Sony_E,
       LIBRAW_SONY_ILCE, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010i, 0x0320,
       0x019f, 0x024b, 0x024c, 0x0208},
      {SonyID_ILCE_7M3, LIBRAW_FORMAT_FF, LIBRAW_MOUNT_Sony_E, LIBRAW_SONY_ILCE,
       LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010i, 0x0320, 0x019f, 0x024b,
       0x024c, 0x0208},
      {SonyID_DSC_RX0, LIBRAW_FORMAT_1INCH, LIBRAW_MOUNT_FixedLens,
       LIBRAW_SONY_DSC, LIBRAW_MOUNT_FixedLens, LIBRAW_SONY_Tag2010h, 0x0346,
       0xffff, 0x025c, 0x025d, 0x0210},
      {SonyID_DSC_RX10M4, LIBRAW_FORMAT_1INCH, LIBRAW_MOUNT_FixedLens,
       LIBRAW_SONY_DSC, LIBRAW_MOUNT_FixedLens, LIBRAW_SONY_Tag2010i, 0x0320,
       0xffff, 0x024b, 0x024c, 0x0208},
      {SonyID_DSC_RX100M6, LIBRAW_FORMAT_1INCH, LIBRAW_MOUNT_FixedLens,
       LIBRAW_SONY_DSC, LIBRAW_MOUNT_FixedLens, LIBRAW_SONY_Tag2010i, 0x0320,
       0xffff, 0x024b, 0x024c, 0x0208},
      {SonyID_DSC_HX99, LIBRAW_FORMAT_1div2p3INCH, LIBRAW_MOUNT_FixedLens,
       LIBRAW_SONY_DSC, LIBRAW_MOUNT_FixedLens, LIBRAW_SONY_Tag2010i, 0x0320,
       0xffff, 0x024b, 0x024c, 0x0208},
      {SonyID_DSC_RX100M5A, LIBRAW_FORMAT_1INCH, LIBRAW_MOUNT_FixedLens,
       LIBRAW_SONY_DSC, LIBRAW_MOUNT_FixedLens, LIBRAW_SONY_Tag2010i, 0x0320,
       0xffff, 0x024b, 0x024c, 0x0208},
      {SonyID_ILCE_6400, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Sony_E,
       LIBRAW_SONY_ILCE, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010i, 0x0320,
       0x019f, 0x024b, 0x024c, 0x0208},
      {SonyID_DSC_RX0M2, LIBRAW_FORMAT_1INCH, LIBRAW_MOUNT_FixedLens,
       LIBRAW_SONY_DSC, LIBRAW_MOUNT_FixedLens, LIBRAW_SONY_Tag2010i, 0x0320,
       0xffff, 0x024b, 0x024c, 0x0208},
      {SonyID_DSC_RX100M7, LIBRAW_FORMAT_1INCH, LIBRAW_MOUNT_FixedLens,
       LIBRAW_SONY_DSC, LIBRAW_MOUNT_FixedLens, LIBRAW_SONY_Tag2010i, 0x0320,
       0xffff, 0x024b, 0x024c, 0x0208},
      {SonyID_ILCE_7RM4, LIBRAW_FORMAT_FF, LIBRAW_MOUNT_Sony_E,
       LIBRAW_SONY_ILCE, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010i, 0x0320,
       0x019f, 0x024b, 0x024c, 0x0208},
      {SonyID_ILCE_9M2, LIBRAW_FORMAT_FF, LIBRAW_MOUNT_Sony_E, LIBRAW_SONY_ILCE,
       LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010i, 0x0320, 0x019f, 0x024b,
       0x024c, 0x0208},
      {SonyID_ILCE_6600, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Sony_E,
       LIBRAW_SONY_ILCE, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010i, 0x0320,
       0x019f, 0x024b, 0x024c, 0x0208},
      {SonyID_ILCE_6100, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Sony_E,
       LIBRAW_SONY_ILCE, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010i, 0x0320,
       0x019f, 0x024b, 0x024c, 0x0208},
      {SonyID_ZV_1, LIBRAW_FORMAT_1INCH, LIBRAW_MOUNT_FixedLens,
       LIBRAW_SONY_DSC, LIBRAW_MOUNT_FixedLens, LIBRAW_SONY_Tag2010i, 0x0320,
       0xffff, 0x024b, 0x024c, 0x0208},
      {SonyID_ILCE_7C, LIBRAW_FORMAT_FF, LIBRAW_MOUNT_Sony_E, LIBRAW_SONY_ILCE,
       LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010i, 0x0320, 0x019f, 0x024b,
       0x024c, 0x0208},

      // a la SonyID_ILCE_6100
      {SonyID_ZV_E10, LIBRAW_FORMAT_APSC, LIBRAW_MOUNT_Sony_E, LIBRAW_SONY_ILCE,
       LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010i, 0x0320, 0x019f, 0x024b,
       0x024c, 0x0208},

      {SonyID_ILCE_7SM3, LIBRAW_FORMAT_FF, LIBRAW_MOUNT_Sony_E,
       LIBRAW_SONY_ILCE, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010None, 0xffff,
       0xffff, 0xffff, 0xffff, 0xffff},
      {SonyID_ILCE_1, LIBRAW_FORMAT_FF, LIBRAW_MOUNT_Sony_E, LIBRAW_SONY_ILCE,
       LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010None, 0xffff, 0xffff, 0xffff,
       0xffff, 0xffff},
      {SonyID_ILME_FX3, LIBRAW_FORMAT_FF, LIBRAW_MOUNT_Sony_E, LIBRAW_SONY_ILCE,
       LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010None, 0xffff, 0xffff, 0xffff,
       0xffff, 0xffff},
      {SonyID_ILCE_7RM3A, LIBRAW_FORMAT_FF, LIBRAW_MOUNT_Sony_E,
       LIBRAW_SONY_ILCE, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010i, 0x0320,
       0x019f, 0x024b, 0x024c, 0x0208},
      {SonyID_ILCE_7RM4A, LIBRAW_FORMAT_FF, LIBRAW_MOUNT_Sony_E,
       LIBRAW_SONY_ILCE, LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010i, 0x0320,
       0x019f, 0x024b, 0x024c, 0x0208},
      {SonyID_ILCE_7M4, LIBRAW_FORMAT_FF, LIBRAW_MOUNT_Sony_E, LIBRAW_SONY_ILCE,
       LIBRAW_MOUNT_Unknown, LIBRAW_SONY_Tag2010None, 0xffff, 0xffff, 0xffff,
       0xffff, 0xffff},
  };
  ilm.CamID = id;
  ...
  for (unsigned i = 0; i < (sizeof SonyCamFeatures / sizeof *SonyCamFeatures);
       i++) {
  ...
  if (sbstr != NULL) {
    ...
    if ((id == SonyID_ILCE_7) || (id == SonyID_ILCE_7R)) {
      ...
      if (imSony.firmware < 2.0f)
        ...
        imSony.ImageCount3_offset = 0x01c0;
    } else if ((id == SonyID_ILCE_7S) || (id == SonyID_ILCE_7M2)) {
      if (imSony.firmware < 1.2f)
  ...
  if ((id == SonyID_ILCE_7SM3) && !strcmp(model, "MODEL-NAME")) {
    imSony.group9050 = LIBRAW_SONY_Tag9050a;
  }
}
...
void LibRaw::parseSonyLensType2(uchar a, uchar b) {
  ...
  } else if ((lid2 > 0xef00) && (lid2 < 0xffff) && (lid2 != 0xff00)) {
...
void LibRaw::process_Sony_0x0116(uchar *buf, ushort len,
                                 unsigned long long id) {
  int i = 0;

  if (((id == SonyID_DSLR_A900) || (id == SonyID_DSLR_A900_APSC) ||
       (id == SonyID_DSLR_A850) || (id == SonyID_DSLR_A850_APSC)) &&
      (len >= 2))
    i = 1;
...
void LibRaw::process_Sony_0x9050(uchar *buf, ushort len,
                                 unsigned long long id) {
  ushort lid;
  uchar s[4];
  int c;
  ...
  if ((imSony.group9050 == LIBRAW_SONY_Tag9050b) ||
    ...
    if ((ilm.CameraMount == LIBRAW_MOUNT_Sony_E) && (id != SonyID_NEX_5N) &&
        (id != SonyID_NEX_7) && (id != SonyID_NEX_VG20)) {
      if (len <= 0x7f)
        return;
...
void LibRaw::process_Sony_0x9400(uchar *buf, ushort len,
                                 unsigned long long /*id*/) {
...
void LibRaw::process_Sony_0x9402(uchar *buf, ushort len) {
  ...
  if ((imSony.CameraType == LIBRAW_SONY_SLT) ||
      (imSony.CameraType == LIBRAW_SONY_ILCA) || (buf[0x00] == 0x05) ||
      (buf[0x00] == 0xff))
    return;

  if (buf[0x02] == 0xff) {
    imCommon.AmbientTemperature = (float)((short)SonySubstitution[buf[0x04]]);
  }
  ...
  if ((len >= 0x2e) && (imSony.CameraType != LIBRAW_SONY_DSC)) {
    imSony.FocusPosition =
        (ushort)SonySubstitution[buf[0x2d]]; // FocusPosition2
  }
  return;
}
...
void LibRaw::process_Sony_0x9406(uchar *buf, ushort len) {
  ...
  imCommon.BatteryTemperature = (float)(SonySubstitution[buf[5]] - 32) / 1.8f;
...
void LibRaw::process_Sony_0x940e(uchar *buf, ushort len,
                                 unsigned long long id) {
  if (len < 3)
    return;
  ...
  if (((imSony.CameraType != LIBRAW_SONY_SLT) &&
      ...
      (id == SonyID_SLT_A33) || (id == SonyID_SLT_A35) ||
      (id == SonyID_SLT_A55))
    return;
  ...
  if (imCommon.afcount < LIBRAW_AFDATA_MAXCOUNT) {
    ...
    imCommon.afdata[imCommon.afcount].AFInfoData =
        (uchar *)malloc(imCommon.afdata[imCommon.afcount].AFInfoData_length);
  ...
  if (imSony.CameraType == LIBRAW_SONY_ILCA) {
    ...
    if (len >= 0x017e) {
      ...
      imSony.nAFPointsUsed = MIN(4, sizeof imSony.AFPointsUsed);
      FORC(imSony.nAFPointsUsed)
...
void LibRaw::parseSonyMakernotes(
  ...
  // printf ("==>> tag 0x%x, len %d, type %d, model =%s=, cam.id 0x%llx,
  // cam.type %d, =%s=\n", tag, len, type, model, ilm.CamID, imSony.CameraType,
  // imSony.MetaVersion);
  ...
  if (tag == 0xb001) // Sony ModelID
  {
    ...
    lid = 0x30 << 2;
    imgdata.shootinginfo.FocusMode = table_buf[lid + 3]
                                         ? LIBRAW_SONY_FOCUSMODE_MF
                                         : LIBRAW_SONY_FOCUSMODE_AF;
    free(table_buf);
    ...
    default:
      ...
      if ((!dng_writer) ||
            ...
            (len == 6118))   // a230, a290, a330, a380, a390
        {
          ...
          imSony.AFPointSelected = table_buf[0x14];
          if (table_buf[0x15]) /* focus mode values translated to values in tag
                                  0x201b */
    ...
    if (!strncasecmp(model, "DSLR-A100", 9)) // WBInfoA100
    {
      ...
      stmread(imgdata.shootinginfo.InternalBodySerial, 13, ifp);
               ...
               (len ==
                19148)) // a700 a850 a900                          : FocusInfo
    {
      ...
      free(table_buf);
      fseek(ifp, 0x09bb - 0x0080,
            SEEK_CUR); // offset 2491 from the start of tag 0x0020
                             ...
                             // NEX-3 NEX-5 NEX-C3 NEX-VG10E         : MoreInfo
    {
      ...
      if ((a) && (c == 1)) {
        ...
        if (strncasecmp(model, "DSLR-A450", 9) &&
            strncasecmp(model, "DSLR-A500", 9) &&
            strncasecmp(model, "DSLR-A550",
                        9)) { // NEX-3, NEX-5, NEX-5C??, NEX-C3, NEX-VG10(E),
                              // a560, a580, a33, a35, a55
  ...
  } else if (tag == 0x2020) // AFPointsUsed
  {
    if (imSony.CameraType != LIBRAW_SONY_DSC) {
      if (imCommon.afcount < LIBRAW_AFDATA_MAXCOUNT) {
        ...
        imCommon.afdata[imCommon.afcount].AFInfoData_order = order;
        imCommon.afdata[imCommon.afcount].AFInfoData_length = len;
        imCommon.afdata[imCommon.afcount].AFInfoData = (uchar *)malloc(
            imCommon.afdata[imCommon.afcount].AFInfoData_length);
        fread(imCommon.afdata[imCommon.afcount].AFInfoData,
              imCommon.afdata[imCommon.afcount].AFInfoData_length, 1, ifp);
        imSony.nAFPointsUsed =
            short(MIN(imCommon.afdata[imCommon.afcount].AFInfoData_length,
                      sizeof imSony.AFPointsUsed));
  ...
  } else if (tag == 0x9050 && len < 256000) // little endian
  {
    ...
    fread(table_buf, len, 1, ifp);
    uc = table_buf[0x00];
    if (((uc == 0x70) || (uc == 0x8a) || (uc == 0xcd) || (uc == 0xe7) ||
         (uc == 0xea)) &&
        (table_buf[0x03] == 0x08)) {
      if ((imSony.CameraType == LIBRAW_SONY_ILCA) ||
          (imSony.CameraType == LIBRAW_SONY_SLT)) {
        imSony.FocusPosition =
            (ushort)SonySubstitution[table_buf[0x20]]; // FocusPosition2
      }
    }
    free(table_buf);
    ...
    if (ilm.LensMount == LIBRAW_MOUNT_Sony_E)
      parseSonyLensType2(SonySubstitution[table_buf[0x4c]],
                         SonySubstitution[table_buf[0x4b]]);
    free(table_buf);
  } else if (((tag == 0xb027) || (tag == 0x010c)) &&
...
public:
  ...
  int tiff_sget(unsigned save, INT64 *tag_offset, unsigned *tag_id,
                unsigned *tag_type, INT64 *tag_dataoffset,
                unsigned *tag_datalen, int *tag_dataunitlen) {
    if ((((*tag_offset) + 12) > _len) ||
        (*tag_offset < 0)) { // abnormal, tag buffer overrun
      return -1;
    }
    int pos = *tag_offset;
    *tag_id = sget2(pos);
    ...
    *tag_dataunitlen = libraw_tagtype_dataunit_bytes(*tag_type);
    if ((*tag_datalen * (*tag_dataunitlen)) > 4) {
      *tag_dataoffset = sget4(pos) - save;
      if ((*tag_dataoffset + *tag_datalen) >
          _len) { // abnormal, tag data buffer overrun
        return -2;
      }
    } else
...
void LibRaw::parseSonySR2(uchar *_cbuf_SR2, unsigned SR2SubIFDOffset,
  ...
  try {
    ...
    WBCTC_count = 0;
    while (entries--) {
      if (cbuf_SR2.tiff_sget(SR2SubIFDOffset, &tag_offset, &tag_id, &tag_type,
                             &tag_dataoffset, &tag_datalen,
                             &tag_dataunitlen) == 0) {
        TagProcessed = 0;
        if (dng_writer == nonDNG) {
          ...
          case 0x7300:
            FORC4 cblack[c] =
                cbuf_SR2.sget2(tag_dataoffset + tag_dataunitlen * c);
            TagProcessed = 1;
            break;
          case 0x7303:
            FORC4 cam_mul[GRBG_2_RGBG(c)] =
                cbuf_SR2.sget2(tag_dataoffset + tag_dataunitlen * c);
            TagProcessed = 1;
            break;
          case 0x7310:
          ...
          case 0x7800:
            for (i = 0; i < 3; i++) {
              num = 0.0;
              for (c = 0; c < 3; c++) {
                imgdata.color.ccm[i][c] = (float)((short)cbuf_SR2.sget2(
                    tag_dataoffset + tag_dataunitlen * (i * 3 + c)));
          ...
          case 0x787f:
            if (tag_datalen == 3) {
              FORC3 imgdata.color.linear_max[c] =
                  cbuf_SR2.sget2(tag_dataoffset + tag_dataunitlen * c);
        ...
        if (!TagProcessed) {
          if ((tag_id >= 0x7480) && (tag_id <= 0x7486)) {
            ...
            if (Sony_SR2_wb_list[i] > 255) {
              ...
              FORC3 icWBCCTC[WBCTC_count][c + 1] =
                  cbuf_SR2.sget2(tag_dataoffset + tag_dataunitlen * c);
            ...
            if (Sony_SR2_wb_list1[i] > 255) {
              ...
              if (Sony_SR2_wb_list1[i] == 3200) {
                FORC3 icWBC[LIBRAW_WBI_StudioTungsten][c] =
                    icWBCCTC[WBCTC_count][c + 1];
                icWBC[LIBRAW_WBI_StudioTungsten][3] =
                    icWBC[LIBRAW_WBI_StudioTungsten][1];
              }
              WBCTC_count++;
            } else {
              FORC3 icWBC[Sony_SR2_wb_list1[i]][c] =
                  cbuf_SR2.sget2(tag_dataoffset + tag_dataunitlen * c);
...
void LibRaw::parseSonySRF(unsigned len) {
  ...
  try {
    ...
    INT64 decrypt_len =
        offset >> 2; /* master key offset value is the next
    ...
    offset = srf_offset + 2;
    srf_offset = srf_buf.sget4(offset + 12 * entries) -
                 save; /* SRF0 ends with SRF1 abs. position */

    /* get SRF1, it has fixed 40 bytes length and contains keys to decode
     * metadata and raw data */
    if (srf_offset < 0 || decrypt_len < srf_offset / 4)
      goto restore_after_parseSonySRF;
    sony_decrypt((unsigned *)(srf_buf.data() + srf_offset),
                 decrypt_len - srf_offset / 4, 1, MasterKey);
    entries = srf_buf.sget2(srf_offset);
    if (entries > 1000)
      goto restore_after_parseSonySRF;
    offset = srf_offset + 2;
    ...
    while (entries--) {
      if (tiff_sget(save, srf_buf.data(), len, &tag_offset, &tag_id, &tag_type,
                    &tag_dataoffset, &tag_datalen, &tag_dataunitlen) == 0) {
        if (tag_id == 0x0000) {
    ...
    /* get SRF2 */
    srf_offset =
        srf_buf.sget4(offset) - save; /* SRFn ends with SRFn+1 position */
    if (srf_offset < 0 || decrypt_len < srf_offset / 4)
      goto restore_after_parseSonySRF;
    sony_decrypt((unsigned *)(srf_buf.data() + srf_offset),
                 decrypt_len - srf_offset / 4, 1, SRF2Key);
    ...
    while (entries--) {
      if (srf_buf.tiff_sget(save, &tag_offset, &tag_id, &tag_type,
                            &tag_dataoffset, &tag_datalen,
                            &tag_dataunitlen) == 0) {
        if ((tag_id >= 0x00c0) && (tag_id <= 0x00ce)) {
          ...
          if (i == 1) {
            icWBC[Sony_SRF_wb_list[nWB]][3] = icWBC[Sony_SRF_wb_list[nWB]][i];
          }
  ...
  restore_after_parseSonySRF:;
      ...
      ...) // srf_buf can raise IO_EOF exception, catch it and return usual way
  {
