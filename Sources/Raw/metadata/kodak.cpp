  ...
  while (entries--) {
    ...
    } else if (tag == 0x03f0) // 1008
    {
      ...
      if (len > 0) {
        ...
        while (pkti != NULL) {
          c = 12;
          if (((int)strlen(pkti) > c) &&
              (!strncasecmp(pkti, "Camera body:", c))) {
          ...
          c = 10;
          if (((int)strlen(pkti) > c) &&
              (!strncasecmp(pkti, "ISO Speed:", c))) {
            iso_speed = atoi(pkti + c);
          }
          c = 13;
          if (((int)strlen(pkti) > c) &&
              (!strncasecmp(pkti, "Focal Length:", c))) {
            ilm.CurFocal = atoi(pkti + c);
          }
          c = 13;
          if (((int)strlen(pkti) > c) &&
              (!strncasecmp(pkti, "Max Aperture:", c))) {
            while (((pkti[c] == ' ') || (pkti[c] == 'f')) &&
                   (c < (int)strlen(pkti))) {
              c++;
            }
          ...
          c = 13;
          if (((int)strlen(pkti) > c) &&
              (!strncasecmp(pkti, "Min Aperture:", c))) {
            while (((pkti[c] == ' ') || (pkti[c] == 'f')) &&
                   (c < (int)strlen(pkti))) {
              c++;
            }
