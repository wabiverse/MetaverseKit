...
void LibRaw::remove_caseSubstr(
    char *string,
    char *subStr) // replace a substring with an equal length of spaces
{
  char *found;
...
void LibRaw::removeExcessiveSpaces(
    char *string) // replace repeating spaces with one space
{
