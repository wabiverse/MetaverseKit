...
int LibRaw::get_decoder_info(libraw_decoder_info_t *d_info) {
  ...
  if (load_raw == &LibRaw::android_tight_load_raw) {
    ...
    d_info->decoder_flags =
        ...
        LIBRAW_DECODER_TRYRAWSPEED3 | LIBRAW_DECODER_ADOBECOPYPIXEL;
    ...
    d_info->decoder_flags =
        LIBRAW_DECODER_TRYRAWSPEED3; /* FIXME: need to make sure correction not
                                        applied*/
    ...
    d_info->decoder_flags =
        LIBRAW_DECODER_TRYRAWSPEED | LIBRAW_DECODER_TRYRAWSPEED;
    ...
    d_info->decoder_flags =
        LIBRAW_DECODER_HASCURVE | LIBRAW_DECODER_TRYRAWSPEED |
        LIBRAW_DECODER_TRYRAWSPEED3 | LIBRAW_DECODER_SONYARW2;
