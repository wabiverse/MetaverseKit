...
LibRaw::LibRaw(unsigned int flags) : memmgr(1024) {
  ...
  imgdata.rawparams.specials =
      0; /* was inverted : LIBRAW_PROCESSING_DP2Q_INTERPOLATERG |
...
#undef FREE
  ...
  MN.pentax.FocusMode[0] = MN.pentax.FocusMode[1] = 0xffff;
  ...
  MN.sony.FlexibleSpotPosition[0] = MN.sony.FlexibleSpotPosition[1] = 0xffff;
