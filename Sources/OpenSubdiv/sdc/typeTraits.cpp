...
//
char const *SchemeTypeTraits::GetName(SchemeType schemeType) {

  return staticTraitsTable[schemeType]._name;
}

Split SchemeTypeTraits::GetTopologicalSplitType(SchemeType schemeType) {

  return staticTraitsTable[schemeType]._splitType;
}

int SchemeTypeTraits::GetRegularFaceSize(SchemeType schemeType) {

  return staticTraitsTable[schemeType]._regularFaceSize;
}

int SchemeTypeTraits::GetRegularVertexValence(SchemeType schemeType) {

  return staticTraitsTable[schemeType]._regularVertexValence;
}

int SchemeTypeTraits::GetLocalNeighborhoodSize(SchemeType schemeType) {
