...
template <typename REAL> inline int SparseMatrix<REAL>::GetCapacity() const {

  return (int)_elements.size();
}

template <typename REAL>
inline void SparseMatrix<REAL>::Resize(int numRows, int numCols,
...
template <typename REAL>
inline void SparseMatrix<REAL>::SetRowSize(int rowIndex, int rowSize) {
...
template <typename REAL>
inline void SparseMatrix<REAL>::Copy(SparseMatrix const &src) {
...
template <typename REAL>
inline void SparseMatrix<REAL>::Swap(SparseMatrix &other) {
