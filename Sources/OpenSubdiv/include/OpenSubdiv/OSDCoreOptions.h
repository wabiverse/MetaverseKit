...
///  subdivision scheme to affect the shape of the limit surface.  These differ
...
public:
  Options()
      : _vtxBoundInterp(VTX_BOUNDARY_NONE), _fvarLinInterp(FVAR_LINEAR_ALL),
        _creasingMethod(CREASE_UNIFORM), _triangleSub(TRI_SUB_CATMARK) {}
  ...
  VtxBoundaryInterpolation GetVtxBoundaryInterpolation() const {
    return (VtxBoundaryInterpolation)_vtxBoundInterp;
  }
