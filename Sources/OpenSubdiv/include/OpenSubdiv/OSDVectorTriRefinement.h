...
//
//  TriRefinement:
//      A TriRefinement is a subclass of Refinement that splits all faces into
//      tris.
//  It provides the configuration of parent-to-child components and the
//  population of all required topological relations in order to complete a
//  valid Refinement.
//
...
protected:
  //
  //  Virtual methods to complete the configuration of the parent-to-child
  //  mapping:
  //
...
private:
  //
  //  Unlike the quad-split, which can share some vectors with the parent Level
  //  since child components correspond to face-vertices, the tri-split must
  //  define its own local vectors to identify the children for each parent
  //  component -- to be referenced within the base class for more
  //  immediate/inline access:
  //
