...
public:
  ...
  void GetIncidentFaceEdgeSharpness(int faceIndex, float *leadingEdgeSharp,
                                    float *trailingEdgeSharp) const;
  //@}
...
inline void VertexDescriptor::SetManifold(bool isManifold) {
  _isManifold = isManifold;
}
inline bool VertexDescriptor::IsManifold() const { return _isManifold; }

inline void VertexDescriptor::SetBoundary(bool isBoundary) {
...
//
inline bool VertexDescriptor::HasIncidentFaceSizes() const {
  return _hasFaceSizes;
}
inline void VertexDescriptor::ClearIncidentFaceSizes() {
  _hasFaceSizes = false;
}

inline void VertexDescriptor::SetIncidentFaceSize(int incFaceIndex,
                                                  int faceSize) {
...
inline int VertexDescriptor::GetIncidentFaceSize(int incFaceIndex) const {

  return _isFinalized ? (_faceSizeOffsets[incFaceIndex + 1] -
...
//
inline bool VertexDescriptor::HasVertexSharpness() const {
  return _vertSharpness > 0.0f;
}
inline void VertexDescriptor::ClearVertexSharpness() { _vertSharpness = 0.0f; }

inline void VertexDescriptor::SetVertexSharpness(float vertSharpness) {
  _vertSharpness = vertSharpness;
}
inline float VertexDescriptor::GetVertexSharpness() const {
...
//  Public inline methods involving vertex sharpness:
//
inline bool VertexDescriptor::HasEdgeSharpness() const {
  return _hasEdgeSharpness;
}
inline void VertexDescriptor::ClearEdgeSharpness() {
  _hasEdgeSharpness = false;
}

inline void VertexDescriptor::SetManifoldEdgeSharpness(int edgeIndex,
                                                       float sharpness) {
...
inline void VertexDescriptor::SetIncidentFaceEdgeSharpness(
...
inline void VertexDescriptor::GetIncidentFaceEdgeSharpness(
    int faceIndex, float *leadingEdgeSharpness,
    float *trailingEdgeSharpness) const {
