...
public:
  /// \brief Handle that can be used as unique patch identifier within
  /// PatchTable
  class PatchHandle {
...
public:
  ...
  /// \brief Returns the control vertex indices for the patch identified by \p
  /// handle
  ...
  /// \brief Returns the stencil table to compute local point face-varying
  /// values
  StencilTable const *
  GetLocalPointFaceVaryingStencilTable(int channel = 0) const;
  ...
  ///
  template <class T>
  void ComputeLocalPointValuesFaceVarying(T const *src, T *dst,
                                          int channel = 0) const;
  //@}
  ...
  /// \brief Returns the 'QuadOffsets' for the Gregory patch identified by \p
  /// handle
  ...
  /// \brief Returns the value indices for a given patch in \p channel
  ConstIndexArray GetPatchFVarValues(int array, int patch,
                                     int channel = 0) const;
  ...
  /// \brief Returns the stride between patches in the value index array of \p
  /// channel
  ...
  PatchParam GetPatchFVarPatchParam(int array, int patch,
                                    int channel = 0) const;

  /// \brief Returns the face-varying for a given patch in \p array in \p
  /// channel
  ...
  GetFVarChannelLinearInterpolation(int channel = 0) const;
  //@}
  ...
  /// \brief Returns the PatchParamTable (PatchParams order matches patch array
  /// sorting)
...
public:
  ...
  ///
  /// @param wDuu    Weights (evaluated basis functions) for 2nd derivative wrt
  /// u
  ///
  /// @param wDuv    Weights (evaluated basis functions) for 2nd derivative wrt
  /// u and v
  ///
  /// @param wDvv    Weights (evaluated basis functions) for 2nd derivative wrt
  /// v
  ///
  template <typename REAL>
  void EvaluateBasis(PatchHandle const &handle, REAL u, REAL v, REAL wP[],
                     REAL wDu[] = 0, REAL wDv[] = 0, REAL wDuu[] = 0,
                     REAL wDuv[] = 0, REAL wDvv[] = 0) const;

  /// \brief  An overloaded version to assist template parameter resolution
  /// when explicitly declaring unused array arguments as 0.
  void EvaluateBasis(PatchHandle const &handle, float u, float v, float wP[],
                     float wDu[] = 0, float wDv[] = 0, float wDuu[] = 0,
                     float wDuv[] = 0, float wDvv[] = 0) const;

  /// \brief  An overloaded version to assist template parameter resolution
  /// when explicitly declaring unused array arguments as 0.
  void EvaluateBasis(PatchHandle const &handle, double u, double v, double wP[],
                     double wDu[] = 0, double wDv[] = 0, double wDuu[] = 0,
                     double wDuv[] = 0, double wDvv[] = 0) const;
  ...
  void EvaluateBasisFaceVarying(PatchHandle const &handle, REAL u, REAL v,
                                REAL wP[], REAL wDu[] = 0, REAL wDv[] = 0,
                                REAL wDuu[] = 0, REAL wDuv[] = 0,
                                REAL wDvv[] = 0, int channel = 0) const;
  ...
  void EvaluateBasisFaceVarying(PatchHandle const &handle, float u, float v,
                                float wP[], float wDu[] = 0, float wDv[] = 0,
                                float wDuu[] = 0, float wDuv[] = 0,
                                float wDvv[] = 0, int channel = 0) const;
  ...
  void EvaluateBasisFaceVarying(PatchHandle const &handle, double u, double v,
                                double wP[], double wDu[] = 0, double wDv[] = 0,
                                double wDuu[] = 0, double wDuv[] = 0,
                                double wDvv[] = 0, int channel = 0) const;
  //@}
...
private:
  ...
  struct PatchArray {
    PatchArray(PatchDescriptor d, int np, Index v, Index p, Index qo)
        : desc(d), numPatches(np), vertIndex(v), patchIndex(p),
          quadOffsetIndex(qo) {}
  ...
  void pushPatchArray(PatchDescriptor desc, int npatches, Index *vidx,
                      Index *pidx, Index *qoidx = 0);
  ...
  void allocateFVarPatchChannelValues(PatchDescriptor regDesc,
                                      PatchDescriptor irregDesc, int numPatches,
                                      int channel);
...
private:
  ...
  std::vector<Index>
      _patchVerts; // Indices of the control vertices of the patches
  ...
  //
  // XXXtakahito: these data will probably be replaced with mask coefficient or
  // something
  //              SchemeWorker populates.
  //
  QuadOffsetsTable _quadOffsetsTable; // Quad offsets (for Gregory patches)
  VertexValenceTable
      _vertexValenceTable; // Vertex valence table (for Gregory patches)
  ...
  //
  std::vector<Index>
      _sharpnessIndices; // Indices of single-crease sharpness (one per patch)
...
PatchTable::StencilTablePtr::Get<float>() const {
  return _fPtr;
}

template <>
inline StencilTableReal<double> *
PatchTable::StencilTablePtr::Get<double>() const {
  return _dPtr;
}

template <>
inline bool PatchTable::LocalPointStencilPrecisionMatchesType<float>() const {
...
template <>
inline bool PatchTable::LocalPointStencilPrecisionMatchesType<double>() const {
  return _vertexPrecisionIsDouble;
}
template <>
inline bool
...
//
template <class T>
inline void PatchTable::ComputeLocalPointValues(T const *src, T *dst) const {
  assert(LocalPointStencilPrecisionMatchesType<float>());
...
template <class T>
inline void PatchTable::ComputeLocalPointValuesVarying(T const *src,
                                                       T *dst) const {
  assert(LocalPointVaryingStencilPrecisionMatchesType<float>());
...
template <class T>
inline void PatchTable::ComputeLocalPointValuesFaceVarying(T const *src, T *dst,
                                                           int channel) const {
  assert(LocalPointFaceVaryingStencilPrecisionMatchesType<float>());
  if (channel >= 0 && channel < (int)_localPointFaceVaryingStencils.size()) {
    if (_localPointFaceVaryingStencils[channel]) {
      _localPointFaceVaryingStencils[channel].Get<float>()->UpdateValues(src,
                                                                         dst);
    }
  }
}
...
//
inline void PatchTable::EvaluateBasis(PatchHandle const &handle, float u,
                                      float v, float wP[], float wDu[],
                                      float wDv[], float wDuu[], float wDuv[],
                                      float wDvv[]) const {

  EvaluateBasis<float>(handle, u, v, wP, wDu, wDv, wDuu, wDuv, wDvv);
}
inline void PatchTable::EvaluateBasis(PatchHandle const &handle, double u,
                                      double v, double wP[], double wDu[],
                                      double wDv[], double wDuu[],
                                      double wDuv[], double wDvv[]) const {

  EvaluateBasis<double>(handle, u, v, wP, wDu, wDv, wDuu, wDuv, wDvv);
}

inline void PatchTable::EvaluateBasisVarying(PatchHandle const &handle, float u,
                                             float v, float wP[], float wDu[],
                                             float wDv[], float wDuu[],
                                             float wDuv[], float wDvv[]) const {

  EvaluateBasisVarying<float>(handle, u, v, wP, wDu, wDv, wDuu, wDuv, wDvv);
}
inline void PatchTable::EvaluateBasisVarying(PatchHandle const &handle,
                                             double u, double v, double wP[],
...
inline void PatchTable::EvaluateBasisFaceVarying(
    PatchHandle const &handle, float u, float v, float wP[], float wDu[],
    float wDv[], float wDuu[], float wDuv[], float wDvv[], int channel) const {

  EvaluateBasisFaceVarying<float>(handle, u, v, wP, wDu, wDv, wDuu, wDuv, wDvv,
                                  channel);
}
inline void PatchTable::EvaluateBasisFaceVarying(PatchHandle const &handle,
                                                 double u, double v,
                                                 double wP[], double wDu[],
                                                 double wDv[], double wDuu[],
                                                 double wDuv[], double wDvv[],
                                                 int channel) const {

  EvaluateBasisFaceVarying<double>(handle, u, v, wP, wDu, wDv, wDuu, wDuv, wDvv,
                                   channel);
}
