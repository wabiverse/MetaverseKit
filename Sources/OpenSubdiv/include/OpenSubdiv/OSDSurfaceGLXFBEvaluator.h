...
public:
  ...
  Create(BufferDescriptor const &srcDesc, BufferDescriptor const &dstDesc,
    ...
    bool interleavedDerivativeBuffers =
        deviceContext ? deviceContext->AreInterleavedDerivativeBuffers()
                      : false;
  ...
  bool EvalStencils(SRC_BUFFER *srcBuffer, BufferDescriptor const &srcDesc,
    ...
    return EvalStencils(
        ...
        stencilTable->GetSizesTexture(), stencilTable->GetOffsetsTexture(),
        stencilTable->GetIndicesTexture(), stencilTable->GetWeightsTexture(),
  ...
  bool EvalStencils(SRC_BUFFER *srcBuffer, BufferDescriptor const &srcDesc,
    ...
    return EvalStencils(
        ...
        dvvBuffer->BindVBO(), dvvDesc, stencilTable->GetSizesTexture(),
        stencilTable->GetOffsetsTexture(), stencilTable->GetIndicesTexture(),
        stencilTable->GetWeightsTexture(), stencilTable->GetDuWeightsTexture(),
        stencilTable->GetDvWeightsTexture(),
  ...
  EvalPatches(SRC_BUFFER *srcBuffer, BufferDescriptor const &srcDesc,
              ...
              PATCH_TABLE *patchTable, GLXFBEvaluator const *instance,
              void *deviceContext = NULL) {
  ...
  bool EvalPatches(SRC_BUFFER *srcBuffer, BufferDescriptor const &srcDesc,
    ...
    return EvalPatches(
        ...
        patchTable->GetPatchArrays(), patchTable->GetPatchIndexTextureBuffer(),
        patchTable->GetPatchParamTextureBuffer());
  }
...
private:
  ...
  struct _StencilKernel {
    ...
    ~_StencilKernel();
    bool
    Compile(BufferDescriptor const &srcDesc, BufferDescriptor const &dstDesc,
            BufferDescriptor const &duDesc, BufferDescriptor const &dvDesc,
            BufferDescriptor const &duuDesc, BufferDescriptor const &duvDesc,
