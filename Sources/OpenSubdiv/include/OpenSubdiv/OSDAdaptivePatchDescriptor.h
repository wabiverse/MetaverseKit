...
public:
  ...
  /// \brief Number of control vertices of Gregory (and Gregory Boundary)
  /// Patches in table.
  ...
  static Vtr::ConstArray<PatchDescriptor>
...
// Returns the number of face-varying control vertices expected for a patch of
// this type
inline short PatchDescriptor::GetNumFVarControlVertices(Type type) {
  return PatchDescriptor::GetNumControlVertices(type);
}

// Allows ordering of patches by type
inline bool PatchDescriptor::operator<(PatchDescriptor const other) const {
