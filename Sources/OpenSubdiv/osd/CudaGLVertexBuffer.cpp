...
CudaGLVertexBuffer *CudaGLVertexBuffer::Create(int numElements, int numVertices,
                                               void *) {
...
void CudaGLVertexBuffer::UpdateData(const float *src, int startVertex,
