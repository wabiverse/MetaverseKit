...
CLVertexBuffer *CLVertexBuffer::Create(int numElements, int numVertices,
                                       cl_context clContext) {
...
void CLVertexBuffer::UpdateData(const float *src, int startVertex,
                                int numVertices, cl_command_queue queue,
                                cl_event *startEvents,
  ...
  cl_int err = clEnqueueWriteBuffer(queue, _clMemory, blocking, offset, size,
                                    src, numStartEvents, startEvents, endEvent);
...
cl_mem CLVertexBuffer::BindCLBuffer(cl_command_queue /* queue */) {
