...
/* static */
bool CpuEvaluator::EvalStencils(const float *src,
...
/* static */
bool CpuEvaluator::EvalStencils(
  ...
  CpuEvalStencils(src, srcDesc, dst, dstDesc, du, duDesc, dv, dvDesc, sizes,
...
bool CpuEvaluator::EvalStencils(
  ...
  CpuEvalStencils(src, srcDesc, dst, dstDesc, du, duDesc, dv, dvDesc, duu,
