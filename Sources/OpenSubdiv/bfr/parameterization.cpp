...
void Parameterization::GetVertexCoord(int vertex, REAL uv[2]) const {
...
template <typename REAL>
void Parameterization::GetEdgeCoord(int edge, REAL t, REAL uv[2]) const {
...
template <typename REAL>
void Parameterization::GetCenterCoord(REAL uv[2]) const {
...
//
template <typename REAL>
int Parameterization::convertCoordToSubFace(bool normalized,
                                            REAL const uvCoord[2],
                                            REAL subCoord[2]) const {
...
template <typename REAL>
void Parameterization::convertSubFaceToCoord(bool normalized, int subFace,
                                             REAL const subCoord[2],
...
template void Parameterization::GetEdgeCoord<float>(int, float,
                                                    float uv[2]) const;
...
template void Parameterization::GetEdgeCoord<double>(int, double,
                                                     double uv[2]) const;
template void Parameterization::GetCenterCoord<double>(double uv[2]) const;

//  Sub-face conversions:
template int
Parameterization::convertCoordToSubFace<float>(bool, float const uvIn[2],
                                               float uvOut[2]) const;
template void
Parameterization::convertSubFaceToCoord<float>(bool, int, float const uvIn[2],
                                               float uvOut[2]) const;

template int
Parameterization::convertCoordToSubFace<double>(bool, double const uvIn[2],
                                                double uvOut[2]) const;
template void
Parameterization::convertSubFaceToCoord<double>(bool, int, double const uvIn[2],
                                                double uvOut[2]) const;
