...
inline Index getAdjacentFace(Vtr::internal::Level const &level, Index edge,
                             Index face) {
...
void PtexIndices::GetAdjacency(TopologyRefiner const &refiner, int face,
                               int quadrant, int adjFaces[4],
