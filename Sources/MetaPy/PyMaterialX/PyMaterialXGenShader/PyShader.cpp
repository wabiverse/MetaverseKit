...
void bindPyShader(py::module &mod) {
  // Note: py::return_value_policy::reference was needed because getStage
  // returns a ShaderStage& and without this parameter it would return a copy
  // and not a reference
  py::class_<mx::Shader, mx::ShaderPtr>(mod, "Shader")
      ...
      .def("getStage",
           static_cast<mx::ShaderStage &(mx::Shader::*)(size_t)>(
               &mx::Shader::getStage),
           py::return_value_policy::reference)
      .def("getStage",
           static_cast<mx::ShaderStage &(mx::Shader::*)(const std::string &)>(
               &mx::Shader::getStage),
           py::return_value_policy::reference)
      ...
      .def("setAttribute",
           static_cast<void (mx::Shader::*)(const std::string &)>(
               &mx::Shader::setAttribute))
      .def("setAttribute",
           static_cast<void (mx::Shader::*)(const std::string &, mx::ValuePtr)>(
               &mx::Shader::setAttribute));
}
