...
void bindPyShaderStage(py::module &mod) {
  ...
  py::class_<mx::VariableBlock, mx::VariableBlockPtr>(mod, "VariableBlock")
      ...
      .def("find", static_cast<mx::ShaderPort *(
                       mx::VariableBlock::*)(const std::string &)>(
                       &mx::VariableBlock::find))
      .def("find", (mx::ShaderPort *
                    (mx::VariableBlock::*)(const mx::ShaderPortPredicate &)) &
                       mx::VariableBlock::find)
      .def("__len__", &mx::VariableBlock::size)
      .def(
          "__getitem__",
          [](const mx::VariableBlock &vb, size_t i) {
            if (i >= vb.size())
  ...
  py::class_<mx::ShaderStage>(mod, "ShaderStage")
      ...
      .def("getUniformBlock", static_cast<mx::VariableBlock &(
                                  mx::ShaderStage::*)(const std::string &)>(
                                  &mx::ShaderStage::getUniformBlock))
      .def("getInputBlock", static_cast<mx::VariableBlock &(
                                mx::ShaderStage::*)(const std::string &)>(
                                &mx::ShaderStage::getInputBlock))
      .def("getOutputBlock", static_cast<mx::VariableBlock &(
                                 mx::ShaderStage::*)(const std::string &)>(
                                 &mx::ShaderStage::getOutputBlock))
      .def("getConstantBlock",
           static_cast<mx::VariableBlock &(mx::ShaderStage::*)()>(
               &mx::ShaderStage::getConstantBlock))
