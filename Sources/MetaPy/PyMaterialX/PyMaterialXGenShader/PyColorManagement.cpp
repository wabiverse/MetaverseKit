...
public:
  ...
  const std::string &getName() const override {
    PYBIND11_OVERLOAD_PURE(const std::string &, mx::ColorManagementSystem,
                           getName);
  }

protected:
  mx::NodeDefPtr
  getNodeDef(const mx::ColorSpaceTransform &transform) const override {
    PYBIND11_OVERLOAD_PURE(mx::NodeDefPtr, mx::ColorManagementSystem,
                           getNodeDef, transform);
  }
};
...
void bindPyColorManagement(py::module &mod) {
  ...
  py::class_<mx::ColorManagementSystem, PyColorManagementSystem,
             mx::ColorManagementSystemPtr>(mod, "ColorManagementSystem")
      .def(py::init<>())
  ...
  py::class_<mx::DefaultColorManagementSystem,
             mx::DefaultColorManagementSystemPtr, mx::ColorManagementSystem>(
      mod, "DefaultColorManagementSystem")
