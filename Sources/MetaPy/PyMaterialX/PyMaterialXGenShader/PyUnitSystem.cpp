...
void bindPyUnitSystem(py::module &mod) {
  py::class_<mx::UnitTransform>(mod, "UnitTransform")
      .def(py::init<const std::string &, const std::string &,
                    const mx::TypeDesc *, const std::string &>())
  ...
  py::class_<mx::UnitSystem, mx::UnitSystemPtr>(mod, "UnitSystem")
      ...
      .def("setUnitConverterRegistry",
           &mx::UnitSystem::setUnitConverterRegistry)
      .def("getUnitConverterRegistry",
           &mx::UnitSystem::getUnitConverterRegistry);
}
