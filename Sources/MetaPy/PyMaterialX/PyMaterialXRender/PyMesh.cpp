...
void bindPyMesh(py::module &mod) {
  py::class_<mx::MeshStream, mx::MeshStreamPtr>(mod, "MeshStream")
      ...
      .def("getData",
           static_cast<mx::MeshFloatBuffer &(mx::MeshStream::*)()>(
               &mx::MeshStream::getData),
  ...
  py::class_<mx::MeshPartition, mx::MeshPartitionPtr>(mod, "MeshPartition")
      ...
      .def("getIndices",
           static_cast<mx::MeshIndexBuffer &(mx::MeshPartition::*)()>(
               &mx::MeshPartition::getIndices),
           py::return_value_policy::reference)
  ...
  py::class_<mx::Mesh, mx::MeshPtr>(mod, "Mesh")
      ...
      .def("getStream", static_cast<mx::MeshStreamPtr (mx::Mesh::*)(
                            const std::string &) const>(&mx::Mesh::getStream))
      .def("getStream",
           static_cast<mx::MeshStreamPtr (mx::Mesh::*)(
               const std::string &, unsigned int) const>(&mx::Mesh::getStream))
