...
void bindPyCamera(py::module &mod) {
  py::class_<mx::Camera, mx::CameraPtr>(mod, "Camera")
      ...
      .def_static("createPerspectiveMatrix",
                  &mx::Camera::createPerspectiveMatrix)
      .def_static("createOrthographicMatrix",
                  &mx::Camera::createOrthographicMatrix)
      .def_static("transformPointPerspective",
                  &mx::Camera::transformPointPerspective);
}
