...
void bindPyMetalTextureHandler(py::module &mod) {
  py::class_<mx::MetalTextureHandler, mx::ImageHandler,
             mx::MetalTextureHandlerPtr>(mod, "MetalTextureHandler")
      ...
      .def("createRenderResources",
           &mx::MetalTextureHandler::createRenderResources)
      .def("releaseRenderResources",
           &mx::MetalTextureHandler::releaseRenderResources,
