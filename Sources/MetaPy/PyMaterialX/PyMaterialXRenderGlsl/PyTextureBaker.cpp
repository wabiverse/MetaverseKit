...
void bindPyTextureBaker(py::module &mod) {
  py::class_<mx::TextureBakerGlsl, mx::GlslRenderer, mx::TextureBakerPtr>(
      mod, "TextureBaker")
      ...
      .def("setTextureFilenameTemplate",
           &mx::TextureBakerGlsl::setTextureFilenameTemplate)
      .def("getTextureFilenameTemplate",
           &mx::TextureBakerGlsl::getTextureFilenameTemplate)
      .def("setFilenameTemplateVarOverride",
           &mx::TextureBakerGlsl::setFilenameTemplateVarOverride)
      ...
      .def("writeDocumentPerMaterial",
           &mx::TextureBakerGlsl::writeDocumentPerMaterial);
}
