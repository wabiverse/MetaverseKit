...
void bindPyGeom(py::module &mod) {
  py::class_<mx::GeomElement, mx::GeomElementPtr, mx::Element>(mod,
                                                               "GeomElement")
  ...
  py::class_<mx::GeomPropDef, mx::GeomPropDefPtr, mx::TypedElement>(
      mod, "GeomPropDef")
  ...
  py::class_<mx::Collection, mx::CollectionPtr, mx::Element>(mod, "Collection")
      ...
      .def("setIncludeCollectionString",
           &mx::Collection::setIncludeCollectionString)
      .def("hasIncludeCollectionString",
           &mx::Collection::hasIncludeCollectionString)
      .def("getIncludeCollectionString",
