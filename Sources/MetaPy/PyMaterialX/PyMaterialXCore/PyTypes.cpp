...
#define BIND_VECTOR_SUBCLASS(V, N)                                             \
  .def(py::init<>())                                                           \
      ...
      .def("dot", &V::dot)                                                     \
      .def("__getitem__", [](const V &v, size_t i) { return v[i]; })           \
      .def("__setitem__", [](V &v, size_t i, float f) { v[i] = f; })           \
      .def("__str__", [](const V &v) { return mx::toValueString(v); })         \
...
#define BIND_MATRIX_SUBCLASS(M, N)                                             \
  .def(py::init<>())                                                           \
      ...
      .def(py::self / float())                                                 \
      .def("__getitem__",                                                      \
           [](const M &m, IndexPair i) { return m[i.first][i.second]; })       \
      .def("__setitem__",                                                      \
           [](M &m, IndexPair i, float f) { m[i.first][i.second] = f; })       \
      .def("__str__", [](const M &m) { return mx::toValueString(m); })         \
...
void bindPyTypes(py::module &mod) {
  ...
  py::class_<mx::Vector2, mx::VectorBase>(mod, "Vector2")
      BIND_VECTOR_SUBCLASS(mx::Vector2, 2)
          ...
          .def("asTuple", [](const mx::Vector2 &v) {
  ...
  py::class_<mx::Vector3, mx::VectorBase>(mod, "Vector3")
      BIND_VECTOR_SUBCLASS(mx::Vector3, 3)
          ...
          .def("asTuple", [](const mx::Vector3 &v) {
  ...
  py::class_<mx::Vector4, mx::VectorBase>(mod, "Vector4")
      BIND_VECTOR_SUBCLASS(mx::Vector4, 4)
          ...
          .def("asTuple", [](const mx::Vector4 &v) {
  ...
  py::class_<mx::Matrix44, mx::MatrixBase>(
      mod, "Matrix44") BIND_MATRIX_SUBCLASS(mx::Matrix44, 4)
      .def(py::init<float, float, float, float, float, float, float, float,
  ...
  mod.attr("DISPLACEMENT_SHADER_TYPE_STRING") =
