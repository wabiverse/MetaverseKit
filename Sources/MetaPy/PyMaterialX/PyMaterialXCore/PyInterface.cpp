...
#define BIND_INTERFACE_TYPE_INSTANCE(NAME, T)                                  \
  .def("_setInputValue" #NAME, &mx::InterfaceElement::setInputValue<T>,        \
       py::arg("name"), py::arg("value"), py::arg("type") = mx::EMPTY_STRING)

void bindPyInterface(py::module &mod) {
  py::class_<mx::PortElement, mx::PortElementPtr, mx::ValueElement>(
      mod, "PortElement")
  ...
  py::class_<mx::Output, mx::OutputPtr, mx::PortElement>(mod, "Output")
      ...
      .def_readonly_static("DEFAULT_INPUT_ATTRIBUTE",
                           &mx::Output::DEFAULT_INPUT_ATTRIBUTE);

  py::class_<mx::InterfaceElement, mx::InterfaceElementPtr, mx::TypedElement>(
      mod, "InterfaceElement")
      ...
      .def("addInput", &mx::InterfaceElement::addInput,
           ...
           py::arg("type") = mx::DEFAULT_TYPE_STRING)
      ...
      .def("hasExactInputMatch", &mx::InterfaceElement::hasExactInputMatch,
           py::arg("declaration"),
           py::arg("message") = nullptr) BIND_INTERFACE_TYPE_INSTANCE(integer,
                                                                      int)
          BIND_INTERFACE_TYPE_INSTANCE(
              boolean, bool) BIND_INTERFACE_TYPE_INSTANCE(float, float)
              BIND_INTERFACE_TYPE_INSTANCE(
                  color3, mx::Color3) BIND_INTERFACE_TYPE_INSTANCE(color4,
                                                                   mx::Color4)
                                          ...
                                          BIND_INTERFACE_TYPE_INSTANCE(
                                              ...
                                              BIND_INTERFACE_TYPE_INSTANCE(
                                                  ...
                                                  BIND_INTERFACE_TYPE_INSTANCE(
                                                      stringarray,
                                                      mx::StringVec)
      .def_readonly_static("NODE_DEF_ATTRIBUTE",
