...
#define BIND_LOOK_FUNC_INSTANCE(NAME, T)                                       \
  .def("_setPropertyValue" #NAME, &mx::Look::setPropertyValue<T>,              \
...
void bindPyLook(py::module &mod) {
  py::class_<mx::Look, mx::LookPtr, mx::Element>(mod, "Look")
      ...
      .def("getActivePropertySetAssigns",
  ...
  py::class_<mx::LookGroup, mx::LookGroupPtr, mx::Element>(mod, "LookGroup")
      ...
      .def_readonly_static("ACTIVE_ATTRIBUTE",
                           &mx::LookGroup::ACTIVE_ATTRIBUTE);

  py::class_<mx::MaterialAssign, mx::MaterialAssignPtr, mx::GeomElement>(
      mod, "MaterialAssign")
  ...
  py::class_<mx::Visibility, mx::VisibilityPtr, mx::GeomElement>(mod,
                                                                 "Visibility")
