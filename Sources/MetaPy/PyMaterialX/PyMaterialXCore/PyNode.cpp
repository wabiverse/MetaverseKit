...
void bindPyNode(py::module &mod) {
  ...
  py::class_<mx::GraphElement, mx::GraphElementPtr, mx::InterfaceElement>(
      mod, "GraphElement")
      .def("addNode", &mx::GraphElement::addNode, py::arg("category"),
  ...
  py::class_<mx::NodeGraph, mx::NodeGraphPtr, mx::GraphElement>(mod,
                                                                "NodeGraph")
  ...
  py::class_<mx::Backdrop, mx::BackdropPtr, mx::Element>(mod, "Backdrop")
      ...
      .def_readonly_static("CONTAINS_ATTRIBUTE",
                           &mx::Backdrop::CONTAINS_ATTRIBUTE)
