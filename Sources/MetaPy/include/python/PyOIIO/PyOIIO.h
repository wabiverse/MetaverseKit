...
#ifndef PYOPENIMAGEIO_PYOIIO_H
#define PYOPENIMAGEIO_PYOIIO_H
...
#  error "You must include Python.h (and therefore PyOIIO.h) BEFORE anything that defines _POSIX_C_SOURCE"
#endif 
#include <Python.h>
// clang-format on
