...
template <typename T>
inline void vecresize(std::vector<T> &values, const ROI &roi,
                      const ImageBuf &buf, bool fill_from_back = false,
                      T fillvalue = T(0)) {
  ...
  T val =
      fill_from_back ? (values.size() ? values.back() : fillvalue) : fillvalue;
  values.resize(len, val);
  OIIO_ASSERT(values.size() > 0);
}

bool IBA_zero(ImageBuf &dst, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::zero(dst, roi, nthreads);
}

ImageBuf IBA_zero_ret(ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::zero(roi, nthreads);
}

bool IBA_fill(ImageBuf &dst, py::object values_tuple, ROI roi = ROI::All(),
              int nthreads = 0) {
...
bool IBA_fill2(ImageBuf &dst, py::object top_tuple, py::object bottom_tuple,
...
bool IBA_fill4(ImageBuf &dst, py::object top_left_tuple,
               py::object top_right_tuple, py::object bottom_left_tuple,
               py::object bottom_right_tuple, ROI roi = ROI::All(),
               int nthreads = 0) {
  ...
  py::gil_scoped_release gil;
  return ImageBufAlgo::fill(dst, top_left, top_right, bottom_left, bottom_right,
                            roi, nthreads);
}

ImageBuf IBA_fill_ret(py::object values_tuple, ROI roi, int nthreads = 0) {
  ImageBuf result;
  IBA_fill(result, values_tuple, roi, nthreads);
  return result;
}

ImageBuf IBA_fill2_ret(py::object top_tuple, py::object bottom_tuple, ROI roi,
                       int nthreads = 0) {
  ImageBuf result;
...
ImageBuf IBA_fill4_ret(py::object top_left_tuple, py::object top_right_tuple,
                       py::object bottom_left_tuple,
                       py::object bottom_right_tuple, ROI roi,
                       int nthreads = 0) {
  ImageBuf result;
...
bool IBA_checker(ImageBuf &dst, int width, int height, int depth,
...
ImageBuf IBA_checker_ret(int width, int height, int depth,
                         py::object color1_tuple, py::object color2_tuple,
                         int xoffset, int yoffset, int zoffset, ROI roi,
                         int nthreads) {
  ImageBuf result;
  IBA_checker(result, width, height, depth, color1_tuple, color2_tuple, xoffset,
              yoffset, zoffset, roi, nthreads);
  return result;
}

bool IBA_noise(ImageBuf &dst, const std::string &type, float A, float B,
               bool mono, int seed, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::noise(dst, type, A, B, mono, seed, roi, nthreads);
}

ImageBuf IBA_noise_ret(const std::string &type, float A, float B, bool mono,
                       int seed, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::noise(type, A, B, mono, seed, roi, nthreads);
}

bool IBA_channels(ImageBuf &dst, const ImageBuf &src, py::tuple channelorder_,
  ...
  py::gil_scoped_release gil;
  return ImageBufAlgo::channels(
      dst, src, (int)nchannels, &channelorder[0],
      channelvalues.size() ? &channelvalues[0] : nullptr,
      newchannelnames.size() ? &newchannelnames[0] : nullptr,
      shuffle_channel_names, nthreads);
}

ImageBuf IBA_channels_ret(const ImageBuf &src, py::tuple channelorder,
...
bool IBA_channel_append(ImageBuf &dst, const ImageBuf &A, const ImageBuf &B,
                        ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::channel_append(dst, A, B, roi, nthreads);
}

ImageBuf IBA_channel_append_ret(const ImageBuf &A, const ImageBuf &B, ROI roi,
                                int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::channel_append(A, B, roi, nthreads);
}

bool IBA_deepen(ImageBuf &dst, const ImageBuf &src, float zvalue, ROI roi,
                int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::deepen(dst, src, zvalue, roi, nthreads);
}

ImageBuf IBA_deepen_ret(const ImageBuf &src, float zvalue, ROI roi,
                        int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::deepen(src, zvalue, roi, nthreads);
}

bool IBA_flatten(ImageBuf &dst, const ImageBuf &src, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::flatten(dst, src, roi, nthreads);
}

ImageBuf IBA_flatten_ret(const ImageBuf &src, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::flatten(src, roi, nthreads);
}

bool IBA_deep_merge(ImageBuf &dst, const ImageBuf &A, const ImageBuf &B,
                    bool occlusion_cull, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::deep_merge(dst, A, B, occlusion_cull, roi, nthreads);
}

ImageBuf IBA_deep_merge_ret(const ImageBuf &A, const ImageBuf &B,
                            bool occlusion_cull, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::deep_merge(A, B, occlusion_cull, roi, nthreads);
}

bool IBA_deep_holdout(ImageBuf &dst, const ImageBuf &src,
                      const ImageBuf &holdout, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::deep_holdout(dst, src, holdout, roi, nthreads);
}

ImageBuf IBA_deep_holdout_ret(const ImageBuf &src, const ImageBuf &holdout,
                              ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::deep_holdout(src, holdout, roi, nthreads);
}

bool IBA_copy(ImageBuf &dst, const ImageBuf &src, TypeDesc convert, ROI roi,
              int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::copy(dst, src, convert, roi, nthreads);
}

ImageBuf IBA_copy_ret(const ImageBuf &src, TypeDesc convert, ROI roi,
                      int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::copy(src, convert, roi, nthreads);
}

bool IBA_crop(ImageBuf &dst, const ImageBuf &src, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::crop(dst, src, roi, nthreads);
}

ImageBuf IBA_crop_ret(const ImageBuf &src, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::crop(src, roi, nthreads);
}

bool IBA_cut(ImageBuf &dst, const ImageBuf &src, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::cut(dst, src, roi, nthreads);
}

ImageBuf IBA_cut_ret(const ImageBuf &src, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::cut(src, roi, nthreads);
}

bool IBA_paste(ImageBuf &dst, int xbegin, int ybegin, int zbegin, int chbegin,
...
bool IBA_rotate90(ImageBuf &dst, const ImageBuf &src, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::rotate90(dst, src, roi, nthreads);
}

ImageBuf IBA_rotate90_ret(const ImageBuf &src, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::rotate90(src, roi, nthreads);
}

bool IBA_rotate180(ImageBuf &dst, const ImageBuf &src, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::rotate180(dst, src, roi, nthreads);
}

ImageBuf IBA_rotate180_ret(const ImageBuf &src, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::rotate180(src, roi, nthreads);
}

bool IBA_rotate270(ImageBuf &dst, const ImageBuf &src, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::rotate270(dst, src, roi, nthreads);
}

ImageBuf IBA_rotate270_ret(const ImageBuf &src, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::rotate270(src, roi, nthreads);
}

bool IBA_flip(ImageBuf &dst, const ImageBuf &src, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::flip(dst, src, roi, nthreads);
}

ImageBuf IBA_flip_ret(const ImageBuf &src, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::flip(src, roi, nthreads);
}

bool IBA_flop(ImageBuf &dst, const ImageBuf &src, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::flop(dst, src, roi, nthreads);
}

ImageBuf IBA_flop_ret(const ImageBuf &src, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::flop(src, roi, nthreads);
}

bool IBA_reorient(ImageBuf &dst, const ImageBuf &src, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::reorient(dst, src, nthreads);
}

ImageBuf IBA_reorient_ret(const ImageBuf &src, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::reorient(src, nthreads);
}

bool IBA_transpose(ImageBuf &dst, const ImageBuf &src, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::transpose(dst, src, roi, nthreads);
}

ImageBuf IBA_transpose_ret(const ImageBuf &src, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::transpose(src, roi, nthreads);
}

bool IBA_circular_shift(ImageBuf &dst, const ImageBuf &src, int xshift,
...
ImageBuf IBA_circular_shift_ret(const ImageBuf &src, int xshift, int yshift,
...
bool IBA_add_color(ImageBuf &dst, const ImageBuf &A, py::object values_tuple,
                   ROI roi = ROI::All(), int nthreads = 0) {
  std::vector<float> values;
  py_to_stdvector(values, values_tuple);
...
bool IBA_add_images(ImageBuf &dst, const ImageBuf &A, const ImageBuf &B,
                    ROI roi = ROI::All(), int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::add(dst, A, B, roi, nthreads);
}

ImageBuf IBA_add_color_ret(const ImageBuf &A, py::object values_tuple,
                           ROI roi = ROI::All(), int nthreads = 0) {
  ImageBuf result;
...
ImageBuf IBA_add_images_ret(const ImageBuf &A, const ImageBuf &B,
                            ROI roi = ROI::All(), int nthreads = 0) {
  py::gil_scoped_release gil;
...
bool IBA_sub_color(ImageBuf &dst, const ImageBuf &A, py::object values_tuple,
                   ROI roi = ROI::All(), int nthreads = 0) {
  std::vector<float> values;
  py_to_stdvector(values, values_tuple);
  vecresize(values, roi, dst, true /*fill_from_back*/);
...
bool IBA_sub_images(ImageBuf &dst, const ImageBuf &A, const ImageBuf &B,
                    ROI roi = ROI::All(), int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::sub(dst, A, B, roi, nthreads);
}

ImageBuf IBA_sub_color_ret(const ImageBuf &A, py::object values_tuple,
                           ROI roi = ROI::All(), int nthreads = 0) {
  ImageBuf result;
...
ImageBuf IBA_sub_images_ret(const ImageBuf &A, const ImageBuf &B,
                            ROI roi = ROI::All(), int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::sub(A, B, roi, nthreads);
}

bool IBA_absdiff_color(ImageBuf &dst, const ImageBuf &A,
                       py::object values_tuple, ROI roi = ROI::All(),
                       int nthreads = 0) {
  std::vector<float> values;
  py_to_stdvector(values, values_tuple);
...
bool IBA_absdiff_images(ImageBuf &dst, const ImageBuf &A, const ImageBuf &B,
                        ROI roi = ROI::All(), int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::absdiff(dst, A, B, roi, nthreads);
}

ImageBuf IBA_absdiff_color_ret(const ImageBuf &A, py::object values_tuple,
                               ROI roi = ROI::All(), int nthreads = 0) {
  ImageBuf result;
...
ImageBuf IBA_absdiff_images_ret(const ImageBuf &A, const ImageBuf &B,
                                ROI roi = ROI::All(), int nthreads = 0) {
  py::gil_scoped_release gil;
...
bool IBA_abs(ImageBuf &dst, const ImageBuf &A, ROI roi = ROI::All(),
             int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::abs(dst, A, roi, nthreads);
}

ImageBuf IBA_abs_ret(const ImageBuf &A, ROI roi = ROI::All(),
                     int nthreads = 0) {
  py::gil_scoped_release gil;
...
bool IBA_mul_color(ImageBuf &dst, const ImageBuf &A, py::object values_tuple,
                   ROI roi = ROI::All(), int nthreads = 0) {
  std::vector<float> values;
  py_to_stdvector(values, values_tuple);
  vecresize(values, roi, A, true /*fill_from_back*/);
...
bool IBA_mul_images(ImageBuf &dst, const ImageBuf &A, const ImageBuf &B,
                    ROI roi = ROI::All(), int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::mul(dst, A, B, roi, nthreads);
}

ImageBuf IBA_mul_color_ret(const ImageBuf &A, py::object values_tuple,
                           ROI roi = ROI::All(), int nthreads = 0) {
  ImageBuf result;
...
ImageBuf IBA_mul_images_ret(const ImageBuf &A, const ImageBuf &B,
                            ROI roi = ROI::All(), int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::mul(A, B, roi, nthreads);
}

bool IBA_div_color(ImageBuf &dst, const ImageBuf &A, py::object values_tuple,
                   ROI roi = ROI::All(), int nthreads = 0) {
  std::vector<float> values;
  py_to_stdvector(values, values_tuple);
  vecresize(values, roi, A, true /*fill_from_back*/);
...
bool IBA_div_images(ImageBuf &dst, const ImageBuf &A, const ImageBuf &B,
                    ROI roi = ROI::All(), int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::div(dst, A, B, roi, nthreads);
}

ImageBuf IBA_div_color_ret(const ImageBuf &A, py::object values_tuple,
                           ROI roi = ROI::All(), int nthreads = 0) {
  ImageBuf result;
...
ImageBuf IBA_div_images_ret(const ImageBuf &A, const ImageBuf &B,
                            ROI roi = ROI::All(), int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::div(A, B, roi, nthreads);
}

bool IBA_mad_color(ImageBuf &dst, const ImageBuf &A, py::object Bvalues_tuple,
...
bool IBA_mad_ici(ImageBuf &dst, const ImageBuf &A, py::object Bvalues_tuple,
...
bool IBA_mad_cii(ImageBuf &dst, py::object Avalues_tuple, const ImageBuf &B,
                 const ImageBuf &C, ROI roi = ROI::All(), int nthreads = 0) {
  return IBA_mad_ici(dst, B, Avalues_tuple, C, roi, nthreads);
}

bool IBA_mad_images(ImageBuf &dst, const ImageBuf &A, const ImageBuf &B,
                    const ImageBuf &C, ROI roi = ROI::All(), int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::mad(dst, A, B, C, roi, nthreads);
}

ImageBuf IBA_mad_color_ret(const ImageBuf &A, py::object Bvalues_tuple,
                           py::object Cvalues_tuple, ROI roi = ROI::All(),
                           int nthreads = 0) {
  ImageBuf result;
...
ImageBuf IBA_mad_ici_ret(const ImageBuf &A, py::object Bvalues_tuple,
                         const ImageBuf &C, ROI roi = ROI::All(),
                         int nthreads = 0) {
  ImageBuf result;
...
ImageBuf IBA_mad_cii_ret(py::object Avalues_tuple, const ImageBuf &B,
                         const ImageBuf &C, ROI roi = ROI::All(),
                         int nthreads = 0) {
  return IBA_mad_ici_ret(B, Avalues_tuple, C, roi, nthreads);
}

ImageBuf IBA_mad_images_ret(const ImageBuf &A, const ImageBuf &B,
                            const ImageBuf &C, ROI roi = ROI::All(),
                            int nthreads = 0) {
  py::gil_scoped_release gil;
...
bool IBA_invert(ImageBuf &dst, const ImageBuf &A, ROI roi = ROI::All(),
                int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::invert(dst, A, roi, nthreads);
}

ImageBuf IBA_invert_ret(const ImageBuf &A, ROI roi = ROI::All(),
                        int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::invert(A, roi, nthreads);
}

bool IBA_pow_color(ImageBuf &dst, const ImageBuf &A, py::object values_tuple,
                   ROI roi = ROI::All(), int nthreads = 0) {
  std::vector<float> values;
  py_to_stdvector(values, values_tuple);
  vecresize(values, roi, A, true /*fill_from_back*/);
...
ImageBuf IBA_pow_color_ret(const ImageBuf &A, py::object values_tuple,
                           ROI roi = ROI::All(), int nthreads = 0) {
  ImageBuf result;
...
bool IBA_min_color(ImageBuf &dst, const ImageBuf &A, py::object values_tuple,
                   ROI roi = ROI::All(), int nthreads = 0) {
  std::vector<float> values;
  py_to_stdvector(values, values_tuple);
  vecresize(values, roi, A, true /*fill_from_back*/);
...
bool IBA_min_images(ImageBuf &dst, const ImageBuf &A, const ImageBuf &B,
                    ROI roi = ROI::All(), int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::min(dst, A, B, roi, nthreads);
}

ImageBuf IBA_min_color_ret(const ImageBuf &A, py::object values_tuple,
                           ROI roi = ROI::All(), int nthreads = 0) {
  ImageBuf result;
...
ImageBuf IBA_min_images_ret(const ImageBuf &A, const ImageBuf &B,
                            ROI roi = ROI::All(), int nthreads = 0) {
  py::gil_scoped_release gil;
...
bool IBA_max_color(ImageBuf &dst, const ImageBuf &A, py::object values_tuple,
                   ROI roi = ROI::All(), int nthreads = 0) {
  std::vector<float> values;
  py_to_stdvector(values, values_tuple);
  vecresize(values, roi, A, true /*fill_from_back*/);
...
bool IBA_max_images(ImageBuf &dst, const ImageBuf &A, const ImageBuf &B,
                    ROI roi = ROI::All(), int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::max(dst, A, B, roi, nthreads);
}

ImageBuf IBA_max_color_ret(const ImageBuf &A, py::object values_tuple,
                           ROI roi = ROI::All(), int nthreads = 0) {
  ImageBuf result;
...
ImageBuf IBA_max_images_ret(const ImageBuf &A, const ImageBuf &B,
                            ROI roi = ROI::All(), int nthreads = 0) {
  py::gil_scoped_release gil;
...
bool IBA_clamp(ImageBuf &dst, const ImageBuf &src, py::object min_,
               py::object max_, bool clampalpha01 = false, ROI roi = ROI::All(),
               int nthreads = 0) {
  if (!src.initialized())
    return false;
...
ImageBuf IBA_clamp_ret(const ImageBuf &src, py::object min_, py::object max_,
                       bool clampalpha01 = false, ROI roi = ROI::All(),
                       int nthreads = 0) {
  ImageBuf dst;
...
bool IBA_maxchan(ImageBuf &dst, const ImageBuf &src, ROI roi = ROI::All(),
                 int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::maxchan(dst, src, roi, nthreads);
}

ImageBuf IBA_maxchan_ret(const ImageBuf &src, ROI roi = ROI::All(),
                         int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::maxchan(src, roi, nthreads);
}

bool IBA_minchan(ImageBuf &dst, const ImageBuf &src, ROI roi = ROI::All(),
                 int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::minchan(dst, src, roi, nthreads);
}

ImageBuf IBA_minchan_ret(const ImageBuf &src, ROI roi = ROI::All(),
                         int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::minchan(src, roi, nthreads);
}

bool IBA_channel_sum_weight(ImageBuf &dst, const ImageBuf &src,
...
bool IBA_channel_sum(ImageBuf &dst, const ImageBuf &src, ROI roi = ROI::All(),
                     int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::channel_sum(dst, src, NULL, roi, nthreads);
}

ImageBuf IBA_channel_sum_weight_ret(const ImageBuf &src,
...
ImageBuf IBA_channel_sum_ret(const ImageBuf &src, ROI roi = ROI::All(),
                             int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::channel_sum(src, {}, roi, nthreads);
}

bool IBA_color_map_values(ImageBuf &dst, const ImageBuf &src, int srcchannel,
  ...
  py::gil_scoped_release gil;
  return ImageBufAlgo::color_map(dst, src, srcchannel, nknots, channels, knots,
                                 roi, nthreads);
}

bool IBA_color_map_name(ImageBuf &dst, const ImageBuf &src, int srcchannel,
  ...
  py::gil_scoped_release gil;
  return ImageBufAlgo::color_map(dst, src, srcchannel, mapname, roi, nthreads);
}

ImageBuf IBA_color_map_values_ret(const ImageBuf &src, int srcchannel,
                                  int nknots, int channels,
                                  py::object knots_tuple, ROI roi = ROI::All(),
                                  int nthreads = 0) {
  ImageBuf dst;
  IBA_color_map_values(dst, src, srcchannel, nknots, channels, knots_tuple, roi,
                       nthreads);
  return dst;
}

ImageBuf IBA_color_map_name_ret(const ImageBuf &src, int srcchannel,
...
bool IBA_rangeexpand(ImageBuf &dst, const ImageBuf &src, bool useluma = false,
                     ROI roi = ROI::All(), int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::rangeexpand(dst, src, useluma, roi, nthreads);
}

ImageBuf IBA_rangeexpand_ret(const ImageBuf &src, bool useluma = false,
                             ROI roi = ROI::All(), int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::rangeexpand(src, useluma, roi, nthreads);
}

bool IBA_rangecompress(ImageBuf &dst, const ImageBuf &src, bool useluma = false,
                       ROI roi = ROI::All(), int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::rangecompress(dst, src, useluma, roi, nthreads);
}

ImageBuf IBA_rangecompress_ret(const ImageBuf &src, bool useluma = false,
                               ROI roi = ROI::All(), int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::rangecompress(src, useluma, roi, nthreads);
}

bool IBA_premult(ImageBuf &dst, const ImageBuf &src, ROI roi = ROI::All(),
                 int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::premult(dst, src, roi, nthreads);
}

ImageBuf IBA_premult_ret(const ImageBuf &src, ROI roi = ROI::All(),
                         int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::premult(src, roi, nthreads);
}

bool IBA_unpremult(ImageBuf &dst, const ImageBuf &src, ROI roi = ROI::All(),
                   int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::unpremult(dst, src, roi, nthreads);
}

ImageBuf IBA_unpremult_ret(const ImageBuf &src, ROI roi = ROI::All(),
                           int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::unpremult(src, roi, nthreads);
}

bool IBA_repremult(ImageBuf &dst, const ImageBuf &src, ROI roi = ROI::All(),
                   int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::repremult(dst, src, roi, nthreads);
}

ImageBuf IBA_repremult_ret(const ImageBuf &src, ROI roi = ROI::All(),
                           int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::repremult(src, roi, nthreads);
}

bool IBA_saturate(ImageBuf &dst, const ImageBuf &src, float scale = 0.0f,
                  int firstchannel = 0, ROI roi = ROI::All(),
                  int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::saturate(dst, src, scale, firstchannel, roi, nthreads);
}

ImageBuf IBA_saturate_ret(const ImageBuf &src, float scale = 0.0f,
                          int firstchannel = 0, ROI roi = ROI::All(),
                          int nthreads = 0) {
  py::gil_scoped_release gil;
...
bool IBA_contrast_remap(ImageBuf &dst, const ImageBuf &src, py::object black_,
  ...
  // scontrast.resize (src.nchannels(), scontrast.size() ? scontrast.back()
  // : 1.0f);
  py::gil_scoped_release gil;
...
ImageBuf IBA_contrast_remap_ret(const ImageBuf &src, py::object black_,
                                py::object white_, py::object min_,
                                py::object max_, py::object scontrast_,
                                py::object sthresh_, ROI roi = ROI::All(),
                                int nthreads = 0) {
  ImageBuf dst;
  IBA_contrast_remap(dst, src, black_, white_, min_, max_, scontrast_, sthresh_,
                     roi, nthreads);
  return dst;
}

ImageBufAlgo::PixelStats IBA_computePixelStats_ret(const ImageBuf &src, ROI roi,
                                                   int nthreads) {
  py::gil_scoped_release gil;
...
// deprecated:
bool IBA_compare(const ImageBuf &A, const ImageBuf &B, float failthresh,
...
bool IBA_compare_Yee(const ImageBuf &A, const ImageBuf &B,
  ...
  py::gil_scoped_release gil;
  return ImageBufAlgo::compare_Yee(A, B, result, luminance, fov, roi, nthreads);
}

std::string IBA_computePixelHashSHA1(const ImageBuf &src,
...
bool IBA_warp(ImageBuf &dst, const ImageBuf &src, py::object values_M,
...
ImageBuf IBA_warp_ret(const ImageBuf &src, py::object values_M,
                      const std::string &filtername = "",
                      float filterwidth = 0.0f, bool recompute_roi = false,
                      const std::string &wrapname = "default",
                      ROI roi = ROI::All(), int nthreads = 0) {
  ImageBuf dst;
  IBA_warp(dst, src, values_M, filtername, filterwidth, recompute_roi, wrapname,
           roi, nthreads);
  return dst;
}

bool IBA_rotate(ImageBuf &dst, const ImageBuf &src, float angle,
                const std::string &filtername = "", float filterwidth = 0.0f,
...
bool IBA_rotate2(ImageBuf &dst, const ImageBuf &src, float angle,
...
ImageBuf IBA_rotate_ret(const ImageBuf &src, float angle,
                        const std::string &filtername = "",
                        float filterwidth = 0.0f, bool recompute_roi = false,
                        ROI roi = ROI::All(), int nthreads = 0) {
  py::gil_scoped_release gil;
...
ImageBuf IBA_rotate2_ret(const ImageBuf &src, float angle, float center_x,
...
bool IBA_resize(ImageBuf &dst, const ImageBuf &src,
                const std::string &filtername = "", float filterwidth = 0.0f,
                ROI roi = ROI::All(), int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::resize(dst, src, filtername, filterwidth, roi, nthreads);
}

ImageBuf IBA_resize_ret(const ImageBuf &src, const std::string &filtername = "",
                        float filterwidth = 0.0f, ROI roi = ROI::All(),
                        int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::resize(src, filtername, filterwidth, roi, nthreads);
}

bool IBA_resample(ImageBuf &dst, const ImageBuf &src, bool interpolate, ROI roi,
                  int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::resample(dst, src, interpolate, roi, nthreads);
}

ImageBuf IBA_resample_ret(const ImageBuf &src, bool interpolate, ROI roi,
                          int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::resample(src, interpolate, roi, nthreads);
}

bool IBA_st_warp(ImageBuf &dst, const ImageBuf &src, const ImageBuf &stbuf,
                 const std::string &filtername = "", float filterwidth = 0.0f,
                 int chan_s = 0, int chan_t = 1, bool flip_s = false,
                 bool flip_t = false, ROI roi = ROI::All(), int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::st_warp(dst, src, stbuf, filtername, filterwidth, chan_s,
                               chan_t, flip_s, flip_t, roi, nthreads);
}

ImageBuf IBA_st_warp_ret(const ImageBuf &src, const ImageBuf &stbuf,
                         const std::string &filtername = "",
                         float filterwidth = 0.0f, int chan_s = 0,
                         int chan_t = 1, bool flip_s = false,
                         bool flip_t = false, ROI roi = ROI::All(),
                         int nthreads = 0) {
  py::gil_scoped_release gil;
...
bool IBA_fit(ImageBuf &dst, const ImageBuf &src,
             const std::string &filtername = "", float filterwidth = 0.0f,
             const std::string &fillmode = "letterbox", bool exact = false,
             ROI roi = ROI::All(), int nthreads = 0) {
  py::gil_scoped_release gil;
...
ImageBuf IBA_fit_ret(const ImageBuf &src, const std::string &filtername = "",
                     float filterwidth = 0.0f,
                     const std::string &fillmode = "letterbox",
                     bool exact = false, ROI roi = ROI::All(),
                     int nthreads = 0) {
  py::gil_scoped_release gil;
...
// DEPRECATED(2.3)
bool IBA_fit_old(ImageBuf &dst, const ImageBuf &src,
                 const std::string &filtername = "", float filterwidth = 0.0f,
...
// DEPRECATED(2.3)
ImageBuf IBA_fit_ret_old(const ImageBuf &src,
                         const std::string &filtername = "",
...
bool IBA_make_kernel(ImageBuf &dst, const std::string &name, float width,
...
ImageBuf IBA_make_kernel_ret(const std::string &name, float width, float height,
                             float depth, bool normalize) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::make_kernel(name, width, height, depth, normalize);
}

bool IBA_convolve(ImageBuf &dst, const ImageBuf &src, const ImageBuf &kernel,
                  bool normalize, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::convolve(dst, src, kernel, normalize, roi, nthreads);
}

ImageBuf IBA_convolve_ret(const ImageBuf &src, const ImageBuf &kernel,
                          bool normalize, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::convolve(src, kernel, normalize, roi, nthreads);
}

bool IBA_unsharp_mask(ImageBuf &dst, const ImageBuf &src,
                      const std::string &kernel, float width, float contrast,
...
ImageBuf IBA_unsharp_mask_ret(const ImageBuf &src, const std::string &kernel,
                              float width, float contrast, float threshold,
                              ROI roi, int nthreads) {
  py::gil_scoped_release gil;
...
bool IBA_median_filter(ImageBuf &dst, const ImageBuf &src, int width,
                       int height, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::median_filter(dst, src, width, height, roi, nthreads);
}

ImageBuf IBA_median_filter_ret(const ImageBuf &src, int width, int height,
                               ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::median_filter(src, width, height, roi, nthreads);
}

bool IBA_dilate(ImageBuf &dst, const ImageBuf &src, int width, int height,
                ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::dilate(dst, src, width, height, roi, nthreads);
}

ImageBuf IBA_dilate_ret(const ImageBuf &src, int width, int height, ROI roi,
                        int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::dilate(src, width, height, roi, nthreads);
}

bool IBA_erode(ImageBuf &dst, const ImageBuf &src, int width, int height,
               ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::erode(dst, src, width, height, roi, nthreads);
}

ImageBuf IBA_erode_ret(const ImageBuf &src, int width, int height, ROI roi,
                       int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::erode(src, width, height, roi, nthreads);
}

bool IBA_laplacian(ImageBuf &dst, const ImageBuf &src, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::laplacian(dst, src, roi, nthreads);
}

ImageBuf IBA_laplacian_ret(const ImageBuf &src, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::laplacian(src, roi, nthreads);
}

bool IBA_fft(ImageBuf &dst, const ImageBuf &src, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::fft(dst, src, roi, nthreads);
}

ImageBuf IBA_fft_ret(const ImageBuf &src, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::fft(src, roi, nthreads);
}

bool IBA_ifft(ImageBuf &dst, const ImageBuf &src, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::ifft(dst, src, roi, nthreads);
}

ImageBuf IBA_ifft_ret(const ImageBuf &src, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::ifft(src, roi, nthreads);
}

bool IBA_polar_to_complex(ImageBuf &dst, const ImageBuf &src, ROI roi,
                          int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::polar_to_complex(dst, src, roi, nthreads);
}

ImageBuf IBA_polar_to_complex_ret(const ImageBuf &src, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::polar_to_complex(src, roi, nthreads);
}

bool IBA_complex_to_polar(ImageBuf &dst, const ImageBuf &src, ROI roi,
                          int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::complex_to_polar(dst, src, roi, nthreads);
}

ImageBuf IBA_complex_to_polar_ret(const ImageBuf &src, ROI roi, int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::complex_to_polar(src, roi, nthreads);
}

bool IBA_normalize(ImageBuf &dst, const ImageBuf &src, float inCenter,
...
ImageBuf IBA_normalize_ret(const ImageBuf &src, float inCenter, float outCenter,
...
bool IBA_fillholes_pushpull(ImageBuf &dst, const ImageBuf &src, ROI roi,
                            int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::fillholes_pushpull(dst, src, roi, nthreads);
}

ImageBuf IBA_fillholes_pushpull_ret(const ImageBuf &src, ROI roi,
                                    int nthreads) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::fillholes_pushpull(src, roi, nthreads);
}

bool IBA_over(ImageBuf &dst, const ImageBuf &A, const ImageBuf &B,
              ROI roi = ROI::All(), int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::over(dst, A, B, roi, nthreads);
}

ImageBuf IBA_over_ret(const ImageBuf &A, const ImageBuf &B,
                      ROI roi = ROI::All(), int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::over(A, B, roi, nthreads);
}

bool IBA_zover(ImageBuf &dst, const ImageBuf &A, const ImageBuf &B,
               bool z_zeroisinf = false, ROI roi = ROI::All(),
               int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::zover(dst, A, B, z_zeroisinf, roi, nthreads);
}

ImageBuf IBA_zover_ret(const ImageBuf &A, const ImageBuf &B,
                       bool z_zeroisinf = false, ROI roi = ROI::All(),
                       int nthreads = 0) {
  py::gil_scoped_release gil;
...
bool IBA_colorconvert(ImageBuf &dst, const ImageBuf &src,
...
bool IBA_colorconvert_colorconfig(ImageBuf &dst, const ImageBuf &src,
  ...
  py::gil_scoped_release gil;
  return ImageBufAlgo::colorconvert(dst, src, from, to, unpremult, context_key,
                                    context_value, &config, roi, nthreads);
}

ImageBuf IBA_colorconvert_ret(const ImageBuf &src, const std::string &from,
                              const std::string &to, bool unpremult = true,
                              ROI roi = ROI::All(), int nthreads = 0) {
  py::gil_scoped_release gil;
...
ImageBuf IBA_colorconvert_colorconfig_ret(
    const ImageBuf &src, const std::string &from, const std::string &to,
    bool unpremult = true, const std::string &context_key = "",
...
bool IBA_colormatrixtransform(ImageBuf &dst, const ImageBuf &src,
                              const py::object &Mobj, bool unpremult = true,
                              ROI roi = ROI::All(), int nthreads = 0) {
  std::vector<float> Mvals;
  bool ok = py_to_stdvector(Mvals, Mobj);
  if (!ok || Mvals.size() != 16) {
    dst.errorfmt("colormatrixtransform did not receive 16 elements to make a "
                 "4x4 matrix");
    return false;
  }
  py::gil_scoped_release gil;
...
ImageBuf IBA_colormatrixtransform_ret(const ImageBuf &src,
                                      const py::object &Mobj,
                                      bool unpremult = true,
                                      ROI roi = ROI::All(), int nthreads = 0) {
  ImageBuf dst;
...
bool IBA_ociolook(ImageBuf &dst, const ImageBuf &src, const std::string &looks,
                  const std::string &from, const std::string &to,
                  bool unpremult, bool inverse, const std::string &context_key,
...
bool IBA_ociolook_colorconfig(ImageBuf &dst, const ImageBuf &src,
                              const std::string &looks, const std::string &from,
                              const std::string &to, bool unpremult,
...
ImageBuf IBA_ociolook_ret(const ImageBuf &src, const std::string &looks,
                          const std::string &from, const std::string &to,
...
ImageBuf IBA_ociolook_colorconfig_ret(
    const ImageBuf &src, const std::string &looks, const std::string &from,
    const std::string &to, bool unpremult, bool inverse,
    const std::string &context_key, const std::string &context_value,
    const std::string &colorconfig = "", ROI roi = ROI::All(),
    int nthreads = 0) {
  ColorConfig config(colorconfig);
  py::gil_scoped_release gil;
  return ImageBufAlgo::ociolook(src, looks, from, to, unpremult, inverse,
...
bool IBA_ociodisplay(ImageBuf &dst, const ImageBuf &src,
...
bool IBA_ociodisplay_colorconfig(
...
ImageBuf IBA_ociodisplay_ret(const ImageBuf &src, const std::string &display,
...
ImageBuf IBA_ociodisplay_colorconfig_ret(
  ...
  py::gil_scoped_release gil;
  return ImageBufAlgo::ociodisplay(src, display, view, from, looks, unpremult,
                                   inverse, context_key, context_value, &config,
                                   roi, nthreads);
}

bool IBA_ociodisplay_dep(ImageBuf &dst, const ImageBuf &src,
                         const std::string &display, const std::string &view,
                         const std::string &from, const std::string &looks,
  ...
  py::gil_scoped_release gil;
  return ImageBufAlgo::ociodisplay(dst, src, display, view, from, looks,
                                   unpremult, false, context_key, context_value,
                                   NULL, roi, nthreads);
}

bool IBA_ociodisplay_dep_colorconfig(
    ImageBuf &dst, const ImageBuf &src, const std::string &display,
    const std::string &view, const std::string &from, const std::string &looks,
    bool unpremult, const std::string &context_key,
    const std::string &context_value, const std::string &colorconfig = "",
...
ImageBuf IBA_ociodisplay_dep_ret(
    const ImageBuf &src, const std::string &display, const std::string &view,
    const std::string &from, const std::string &looks, bool unpremult,
    const std::string &context_key, const std::string &context_value,
    ROI roi = ROI::All(), int nthreads = 0) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::ociodisplay(src, display, view, from, looks, unpremult,
                                   false, context_key, context_value, NULL, roi,
                                   nthreads);
}

ImageBuf IBA_ociodisplay_dep_colorconfig_ret(
    const ImageBuf &src, const std::string &display, const std::string &view,
    const std::string &from, const std::string &looks, bool unpremult,
    const std::string &context_key, const std::string &context_value,
    const std::string &colorconfig = "", ROI roi = ROI::All(),
...
bool IBA_ociofiletransform(ImageBuf &dst, const ImageBuf &src,
                           const std::string &name, bool unpremult,
                           bool inverse, ROI roi = ROI::All(),
                           int nthreads = 0) {
  py::gil_scoped_release gil;
...
bool IBA_ociofiletransform_colorconfig(ImageBuf &dst, const ImageBuf &src,
                                       const std::string &name, bool unpremult,
                                       bool inverse,
                                       const std::string &colorconfig = "",
                                       ROI roi = ROI::All(), int nthreads = 0) {
...
ImageBuf IBA_ociofiletransform_ret(const ImageBuf &src, const std::string &name,
                                   bool unpremult, bool inverse,
                                   ROI roi = ROI::All(), int nthreads = 0) {
  py::gil_scoped_release gil;
...
ImageBuf IBA_ociofiletransform_colorconfig_ret(
    const ImageBuf &src, const std::string &name, bool unpremult, bool inverse,
    const std::string &colorconfig = "", ROI roi = ROI::All(),
    int nthreads = 0) {
  ColorConfig config(colorconfig);
  py::gil_scoped_release gil;
  return ImageBufAlgo::ociofiletransform(src, name, unpremult, inverse, &config,
                                         roi, nthreads);
}

py::object IBA_isConstantColor(const ImageBuf &src, float threshold,
                               ROI roi = ROI::All(), int nthreads = 0) {
...
bool IBA_isMonochrome(const ImageBuf &src, float threshold, ROI roi,
                      int nthreads) {
  py::gil_scoped_release gil;
...
py::object IBA_color_range_check(ImageBuf &src, const py::object &low,
                                 const py::object &high, ROI roi,
                                 int nthreads) {
  ...
  bool ok;
  {
    ...
    ok = ImageBufAlgo::color_range_check(src, &lowcount, &highcount,
                                         &inrangecount, lowvec, highvec, roi,
                                         nthreads);
  }
  py::object result;
  if (ok) {
...
bool IBA_render_point(ImageBuf &dst, int x, int y, py::object color_) {
...
bool IBA_render_line(ImageBuf &dst, int x1, int y1, int x2, int y2,
...
bool IBA_render_box(ImageBuf &dst, int x1, int y1, int x2, int y2,
...
bool IBA_render_text(ImageBuf &dst, int x, int y, const std::string &text,
...
ROI IBA_text_size(const std::string &text, int fontsize = 16,
                  const std::string &fontname = "") {
  py::gil_scoped_release gil;
  return ImageBufAlgo::text_size(text, fontsize, fontname);
}

py::object IBA_histogram(const ImageBuf &src, int channel = 0, int bins = 256,
                         float min = 0.0f, float max = 1.0f,
                         bool ignore_empty = false, ROI roi = {},
                         int nthreads = 0) {
  std::vector<int> h;
  {
    py::gil_scoped_release gil;
...
bool IBA_capture_image(ImageBuf &dst, int cameranum,
...
ImageBuf IBA_capture_image_ret(int cameranum,
                               TypeDesc::BASETYPE convert = TypeDesc::UNKNOWN) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::capture_image(cameranum, convert);
}

bool IBA_make_texture_ib(ImageBufAlgo::MakeTextureMode mode,
                         const ImageBuf &buf, const std::string &outputfilename,
                         const ImageSpec &config) {
  py::gil_scoped_release gil;
  return ImageBufAlgo::make_texture(mode, buf, outputfilename, config);
}

bool IBA_make_texture_filename(ImageBufAlgo::MakeTextureMode mode,
...
void declare_imagebufalgo(py::module &m) {
  ...
  py::class_<IBA_dummy>(m, "ImageBufAlgo")
      ...
      .def_static("fill", &IBA_fill, "dst"_a, "values"_a, "roi"_a = ROI::All(),
                  "nthreads"_a = 0)
      ...
      .def_static("checker", &IBA_checker, "dst"_a, "width"_a, "height"_a,
                  ...
                  "nthreads"_a = 0)
      .def_static("checker", &IBA_checker_ret, "width"_a, "height"_a, "depth"_a,
                  "color1"_a, "color2"_a, "xoffset"_a = 0, "yoffset"_a = 0,
                  "zoffset"_a = 0, "roi"_a = ROI::All(), "nthreads"_a = 0)

      .def_static("noise", &IBA_noise, "dst"_a, "type"_a = "gaussian",
                  "A"_a = 0.0f, "B"_a = 0.1f, "mono"_a = false, "seed"_a = 0,
                  "roi"_a = ROI::All(), "nthreads"_a = 0)
      .def_static("noise", &IBA_noise_ret, "type"_a = "gaussian", "A"_a = 0.0f,
                  "B"_a = 0.1f, "mono"_a = false, "seed"_a = 0,
                  "roi"_a = ROI::All(), "nthreads"_a = 0)

      .def_static("bluenoise_image", &ImageBufAlgo::bluenoise_image)

      .def_static("channels", &IBA_channels, "dst"_a, "src"_a, "channelorder"_a,
      ...
      .def_static("copy", IBA_copy, "dst"_a, "src"_a, "convert"_a = TypeUnknown,
                  "roi"_a = ROI::All(), "nthreads"_a = 0)
      ...
      .def_static("rotate180", IBA_rotate180, "dst"_a, "src"_a,
                  "roi"_a = ROI::All(), "nthreads"_a = 0)
      .def_static("rotate180", IBA_rotate180_ret, "src"_a, "roi"_a = ROI::All(),
                  "nthreads"_a = 0)

      .def_static("rotate270", IBA_rotate270, "dst"_a, "src"_a,
                  "roi"_a = ROI::All(), "nthreads"_a = 0)
      .def_static("rotate270", IBA_rotate270_ret, "src"_a, "roi"_a = ROI::All(),
                  "nthreads"_a = 0)
      ...
      .def_static("reorient", IBA_reorient, "dst"_a, "src"_a, "nthreads"_a = 0)
      .def_static("reorient", IBA_reorient_ret, "src"_a, "nthreads"_a = 0)

      .def_static("transpose", IBA_transpose, "dst"_a, "src"_a,
                  "roi"_a = ROI::All(), "nthreads"_a = 0)
      .def_static("transpose", IBA_transpose_ret, "src"_a, "roi"_a = ROI::All(),
                  "nthreads"_a = 0)

      .def_static("circular_shift", &IBA_circular_shift, "dst"_a, "src"_a,
                  "xshift"_a, "yshift"_a, "zshift"_a = 0, "roi"_a = ROI::All(),
                  "nthreads"_a = 0)
      ...
      .def_static("add", &IBA_add_images_ret, "A"_a, "B"_a,
                  "roi"_a = ROI::All(), "nthreads"_a = 0)
      .def_static("add", IBA_add_color_ret, "A"_a, "B"_a, "roi"_a = ROI::All(),
                  "nthreads"_a = 0)
      ...
      .def_static("sub", &IBA_sub_images_ret, "A"_a, "B"_a,
                  "roi"_a = ROI::All(), "nthreads"_a = 0)
      .def_static("sub", IBA_sub_color_ret, "A"_a, "B"_a, "roi"_a = ROI::All(),
                  "nthreads"_a = 0)
      ...
      .def_static("mul", &IBA_mul_images_ret, "A"_a, "B"_a,
                  "roi"_a = ROI::All(), "nthreads"_a = 0)
      .def_static("mul", &IBA_mul_color_ret, "A"_a, "B"_a, "roi"_a = ROI::All(),
                  "nthreads"_a = 0)
      ...
      .def_static("div", &IBA_div_images_ret, "A"_a, "B"_a,
                  "roi"_a = ROI::All(), "nthreads"_a = 0)
      .def_static("div", &IBA_div_color_ret, "A"_a, "B"_a, "roi"_a = ROI::All(),
                  "nthreads"_a = 0)
      ...
      .def_static("pow", &IBA_pow_color, "dst"_a, "A"_a, "B"_a,
                  "roi"_a = ROI::All(), "nthreads"_a = 0)
      .def_static("pow", &IBA_pow_color_ret, "A"_a, "B"_a, "roi"_a = ROI::All(),
                  "nthreads"_a = 0)
      ...
      .def_static("color_map", &IBA_color_map_values, "dst"_a, "src"_a,
                  ...
                  "roi"_a = ROI::All(), "nthreads"_a = 0)
      .def_static("color_map", &IBA_color_map_name_ret, "src"_a, "srcchannel"_a,
                  "mapname"_a, "roi"_a = ROI::All(), "nthreads"_a = 0)
      ...
      .def_static("min", &IBA_min_images_ret, "A"_a, "B"_a,
                  "roi"_a = ROI::All(), "nthreads"_a = 0)
      .def_static("min", IBA_min_color_ret, "A"_a, "B"_a, "roi"_a = ROI::All(),
                  "nthreads"_a = 0)
      ...
      .def_static("max", &IBA_max_images_ret, "A"_a, "B"_a,
                  "roi"_a = ROI::All(), "nthreads"_a = 0)
      .def_static("max", IBA_max_color_ret, "A"_a, "B"_a, "roi"_a = ROI::All(),
                  "nthreads"_a = 0)
      ...
      .def_static("saturate", &IBA_saturate, "dst"_a, "src"_a, "scale"_a = 0.0f,
                  "firstchannel"_a = 0, "roi"_a = ROI::All(), "nthreads"_a = 0)
      ...
      .def_static("colorconvert", &IBA_colorconvert_colorconfig, "dst"_a,
                  ...
                  "colorconfig"_a = "", "roi"_a = ROI::All(), "nthreads"_a = 0)
      .def_static("colorconvert", &IBA_colorconvert_ret, "src"_a, "fromspace"_a,
                  "tospace"_a, "unpremult"_a = true, "roi"_a = ROI::All(),
                  "nthreads"_a = 0)
      ...
      .def_static("ociolook", &IBA_ociolook_ret, "src"_a, "looks"_a,
                  ...
                  "context_value"_a = "", "roi"_a = ROI::All(),
                  "nthreads"_a = 0)
      .def_static("ociolook", &IBA_ociolook_colorconfig_ret, "src"_a, "looks"_a,
                  "fromspace"_a, "tospace"_a, "unpremult"_a = true,
                  "inverse"_a = false, "context_key"_a = "",
                  "context_value"_a = "", "colorconfig"_a = "",
                  "roi"_a = ROI::All(), "nthreads"_a = 0)
      ...
      .def_static("ociodisplay", &IBA_ociodisplay, "dst"_a, "src"_a,
                  ...
                  "context_key"_a = "", "context_value"_a = "",
                  "roi"_a = ROI::All(), "nthreads"_a = 0)
      .def_static("ociodisplay", &IBA_ociodisplay_colorconfig, "dst"_a, "src"_a,
                  "display"_a, "view"_a, "fromspace"_a = "", "looks"_a = "",
                  "unpremult"_a = true, "inverse"_a = false,
                  "context_key"_a = "", "context_value"_a = "",
                  "colorconfig"_a = "", "roi"_a = ROI::All(), "nthreads"_a = 0)
      ...
      .def_static("ociodisplay", &IBA_ociodisplay_dep_colorconfig, "dst"_a,
                  ...
                  "unpremult"_a, "context_key"_a, "context_value"_a,
                  "colorconfig"_a = "", "roi"_a = ROI::All(), "nthreads"_a = 0)
      .def_static("ociodisplay", &IBA_ociodisplay_dep_ret, "src"_a, "display"_a,
                  "view"_a, "fromspace"_a, "looks"_a, "unpremult"_a,
                  "context_key"_a, "context_value"_a = "", "roi"_a = ROI::All(),
                  "nthreads"_a = 0)
      .def_static("ociodisplay", &IBA_ociodisplay_dep_colorconfig_ret, "src"_a,
                  "display"_a, "view"_a, "fromspace"_a, "looks"_a,
                  "unpremult"_a, "context_key"_a, "context_value"_a = "",
                  "colorconfig"_a = "", "roi"_a = ROI::All(), "nthreads"_a = 0)

      .def_static("ociofiletransform", &IBA_ociofiletransform, "dst"_a, "src"_a,
      ...
      .def_static("ociofiletransform", &IBA_ociofiletransform_colorconfig_ret,
                  "src"_a, "name"_a, "unpremult"_a = true, "inverse"_a = false,
                  "colorconfig"_a = "", "roi"_a = ROI::All(), "nthreads"_a = 0)
      ...
      .def_static("compare", &IBA_compare_ret, "A"_a, "B"_a, "failthresh"_a,
                  ...
                  "nthreads"_a = 0)
      .def_static("compare", &IBA_compare_ret_old, "A"_a, "B"_a, "failthresh"_a,
      ...
      .def_static("isConstantColor", &IBA_isConstantColor, "src"_a,
                  "threshold"_a = 0.0f, "roi"_a = ROI::All(), "nthreads"_a = 0)
      ...
      .def_static("color_range_check", &IBA_color_range_check, "src"_a, "low"_a,
                  "high"_a, "roi"_a = ROI::All(), "nthreads"_a = 0)
      ...
      .def_static("warp", &IBA_warp_ret, "src"_a, "M"_a, "filtername"_a = "",
                  ...
                  "wrap"_a = "default", "roi"_a = ROI::All(), "nthreads"_a = 0)
      ...
      .def_static("rotate", &IBA_rotate_ret, "src"_a, "angle"_a,
                  ...
                  "recompute_roi"_a = false, "roi"_a = ROI::All(),
                  "nthreads"_a = 0)
      .def_static("rotate", &IBA_rotate2_ret, "src"_a, "angle"_a, "center_x"_a,
                  "center_y"_a, "filtername"_a = "", "filterwidth"_a = 0.0f,
                  "recompute_roi"_a = false, "roi"_a = ROI::All(),
                  "nthreads"_a = 0)

      .def_static("resize", &IBA_resize, "dst"_a, "src"_a, "filtername"_a = "",
      ...
      .def_static("make_kernel", &IBA_make_kernel, "dst"_a, "name"_a, "width"_a,
      ...
      .def_static("fixNonFinite", &IBA_fixNonFinite, "dst"_a, "src"_a,
                  "mode"_a = ImageBufAlgo::NONFINITE_BOX3, "roi"_a = ROI::All(),
                  "nthreads"_a = 0)
      ...
      .def_static("normalize", &IBA_normalize, "dst"_a, "src"_a,
                  ...
                  "roi"_a = ROI::All(), "nthreads"_a = 0)
      .def_static("normalize", &IBA_normalize_ret, "src"_a, "inCenter"_a = 0.0f,
                  "outCenter"_a = 0.0f, "scale"_a = 1.0f, "roi"_a = ROI::All(),
                  "nthreads"_a = 0)
      ...
      .def_static("render_text", &IBA_render_text, "dst"_a, "x"_a, "y"_a,
                  ...
                  "aligny"_a = "baseline", "shadow"_a = 0, "roi"_a = ROI::All(),
                  "nthreads"_a = 0)
