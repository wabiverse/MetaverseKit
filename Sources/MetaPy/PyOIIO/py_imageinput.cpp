...
static py::object ImageInput_read_image(ImageInput &self, int subimage,
                                        int miplevel, int chbegin, int chend,
                                        TypeDesc format) {
  ...
  bool ok;
  {
    ...
    ok =
        self.read_image(subimage, miplevel, chbegin, chend, format, data.get());
  }
  if (ok)
...
static py::object ImageInput_read_scanlines(ImageInput &self, int subimage,
...
static py::object ImageInput_read_tiles(ImageInput &self, int subimage,
  ...
  {
    py::gil_scoped_release gil;
    ok = self.read_tiles(subimage, miplevel, xbegin, xend, ybegin, yend, zbegin,
                         zend, chbegin, chend, format, data.get());
  }
  if (ok)
    return make_numpy_array(format, data.release(), dims, nchans, xend - xbegin,
                            yend - ybegin, zend - zbegin);
  else
    return py::none();
}

py::object ImageInput_read_native_deep_scanlines(ImageInput &self, int subimage,
                                                 int miplevel, int ybegin,
  ...
  bool ok = true;
  {
    ...
    ok = self.read_native_deep_scanlines(subimage, miplevel, ybegin, yend, z,
                                         chbegin, chend, *dd);
  }
  return ok ? py::cast(dd.release()) : py::none();
}

py::object ImageInput_read_native_deep_tiles(ImageInput &self, int subimage,
                                             int miplevel, int xbegin, int xend,
                                             int ybegin, int yend, int zbegin,
                                             int zend, int chbegin, int chend) {
  std::unique_ptr<DeepData> dd;
  bool ok = true;
  {
    py::gil_scoped_release gil;
    dd.reset(new DeepData);
    ok = self.read_native_deep_tiles(subimage, miplevel, xbegin, xend, ybegin,
                                     yend, zbegin, zend, chbegin, chend, *dd);
  }
  return ok ? py::cast(dd.release()) : py::none();
}

py::object ImageInput_read_native_deep_image(ImageInput &self, int subimage,
                                             int miplevel) {
  std::unique_ptr<DeepData> dd;
  bool ok = true;
  {
  ...
  py::class_<ImageInput>(m, "ImageInput")
      ...
      .def(
          ...
          [](ImageInput &self, int chbegin, int chend,
            ...
            return ImageInput_read_image(self, 0, 0, chbegin, chend, format);
          },
      ...
      .def(
          ...
          [](ImageInput &self, int y, int z, TypeDesc format) -> py::object {
            return ImageInput_read_scanlines(self, self.current_subimage(),
                                             self.current_miplevel(), y, y + 1,
                                             z, 0, 10000, format, 2);
          },
          "y"_a, "z"_a = 0, "format"_a = TypeFloat)
      .def(
          "read_scanlines",
          [](ImageInput &self, int subimage, int miplevel, int ybegin, int yend,
             int z, int chbegin, int chend, TypeDesc format) -> py::object {
            return ImageInput_read_scanlines(self, subimage, miplevel, ybegin,
                                             yend, z, chbegin, chend, format,
                                             3);
          },
          "subimage"_a, "miplevel"_a, "ybegin"_a, "yend"_a, "z"_a, "chbegin"_a,
          "chend"_a, "format"_a = TypeFloat)
      .def(
          "read_scanlines",
          [](ImageInput &self, int ybegin, int yend, int z, int chbegin,
             int chend, TypeDesc format) -> py::object {
            return ImageInput_read_scanlines(
                self, self.current_subimage(), self.current_miplevel(), ybegin,
                yend, z, chbegin, chend, format, 3);
          },
          "ybegin"_a, "yend"_a, "z"_a, "chbegin"_a, "chend"_a,
          "format"_a = TypeFloat)
      .def(
          "read_tiles",
          [](ImageInput &self, int subimage, int miplevel, int xbegin, int xend,
             int ybegin, int yend, int zbegin, int zend, int chbegin, int chend,
             TypeDesc format) -> py::object {
            return ImageInput_read_tiles(self, subimage, miplevel, xbegin, xend,
      ...
      .def(
          ...
          [](ImageInput &self, int xbegin, int xend, int ybegin, int yend,
             ...
             TypeDesc format) -> py::object {
            return ImageInput_read_tiles(
                self, self.current_subimage(), self.current_miplevel(), xbegin,
                xend, ybegin, yend, zbegin, zend, chbegin, chend, format);
          },
      ...
      .def(
          ...
          [](ImageInput &self, int x, int y, int z,
            ...
            return ImageInput_read_tiles(
                self, self.current_subimage(), self.current_miplevel(), x,
                x + spec.tile_width, y, y + spec.tile_height, z,
                z + std::max(1, spec.tile_depth), 0, spec.nchannels, format);
          },
      ...
      .def("read_native_deep_scanlines", &ImageInput_read_native_deep_scanlines,
           ...
           "chend"_a)
      .def(
          "read_native_deep_scanlines", // DEPRECATED(1.9), keep for back
                                        // compatibility
          [](ImageInput &self, int ybegin, int yend, int z, int chbegin,
             int chend) {
            int subimage = self.current_subimage();
            int miplevel = self.current_miplevel();
            return ImageInput_read_native_deep_scanlines(
                self, subimage, miplevel, ybegin, yend, z, chbegin, chend);
          },
          "ybegin"_a, "yend"_a, "z"_a, "chbegin"_a, "chend"_a)
      .def("read_native_deep_tiles", &ImageInput_read_native_deep_tiles,
           ...
           "yend"_a, "zbegin"_a, "zend"_a, "chbegin"_a, "chend"_a)
      .def(
          "read_native_deep_tiles", // DEPRECATED(1.9), keep for back
                                    // compatibility
          [](ImageInput &self, int xbegin, int xend, int ybegin, int yend,
             int zbegin, int zend, int chbegin, int chend) {
            return ImageInput_read_native_deep_tiles(self, 0, 0, xbegin, xend,
